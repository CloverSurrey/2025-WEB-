/** v2.11.2 | MIT Licensed */ !(function (h) {
  "use strict";
  var e,
    d = h.document,
    v = h.location,
    m = { timeout: 10, debug: !1, version: !1 },
    g = { modules: {}, status: {}, event: {}, callback: {} },
    r = function () {
      this.v = "2.11.2";
    },
    t = h.LAYUI_GLOBAL || {},
    b =
      ((e =
        d.currentScript && "SCRIPT" === d.currentScript.tagName.toUpperCase()
          ? d.currentScript.src
          : (function () {
              for (
                var e,
    ...
    j = function (e, t) {
      (t = t || "log"),
        h.console && console[t] && console[t]("layui error hint: " + e);
    },
    E = (m.builtin = {
      lay: "lay",
      layer: "layer",
    ...
    l =
      ((r.prototype.cache = Object.assign(m, g)),
      (r.prototype.config = function (e) {
        return Object.assign(m, e), this;
      }),
      (r.prototype.define = function (e, r) {
        return (
          ...
          this.use(
            ...
            function () {
              var n = function (e, t) {
                (layui[e] = t), (g.status[e] = !0);
              };
              return (
                "function" == typeof r &&
                  r(function (e, t) {
                    n(e, t),
                      (g.callback[e] = function () {
                        r(n);
                      });
                  }),
                this
      ...
      (r.prototype.use = function (n, e, t, r) {
        var o,
          a,
          i,
          u,
        ...
        return (
          ...
          n &&
            ...
            (c = function () {
              var e = 0;
              !(function t() {
                return ++e > (1e3 * m.timeout) / 5
                  ? j(o + " is not a valid module", "error")
                  : void ((i ? (layui[o] = h[a.api]) : g.status[o])
                      ? u()
                      : setTimeout(t, 5));
              })();
            }),
            0 === n.length || (layui["layui.all"] && E[o])
              ? u()
              : ((p = i ? a.src : a),
                (y =
                  (E[o] ? y + "modules/" : p ? "" : m.base) +
                  (p = (p = p || o)
                    .replace(/\s/g, "")
                    .replace(/\.js[^\/\.]*$/, "")) +
                  ".js"),
                !g.modules[o] && layui[o] && (g.modules[o] = y),
                g.modules[o]
                  ? c()
                  : ((l = d.getElementsByTagName("head")[0]),
                    ((s = d.createElement("script"))["async"] = !0),
                    (s.charset = "utf-8"),
                    (s.src =
                      y +
                      ((p =
      ...
      (r.prototype.modules = Object.assign({}, E)),
      (r.prototype.extend = function (e) {
        var t,
          ...
          o = /^\{\/\}/;
        for (t in (e = e || {}))
          this[t] || this.modules[t]
            ? j("the " + t + " module already exists, extend failure")
            : ("string" == typeof (n = e[t]) &&
                (n = ((r = o.test(n) ? "" : r) + n).replace(o, "")),
              (this.modules[t] = n));
        return this;
      }),
      (r.prototype.disuse = function (e) {
        var n = this;
        return (
          (e = n.isArray(e) ? e : [e]),
      ...
      (r.prototype.getStyle = function (e, t) {
        e = e.currentStyle || h.getComputedStyle(e, null);
        return e.getPropertyValue
          ? e.getPropertyValue(t)
          : e.getAttribute(
              t.replace(/-(\w)/g, function (e, t) {
                return t ? t.toUpperCase() : "";
              })
            );
      }),
      (r.prototype.link = function (n, r, o) {
        var a,
          i = this,
          e = d.getElementsByTagName("head")[0],
          t = "function" == typeof r;
        if (("string" == typeof r && (o = r), "object" == typeof n))
          return (
            (a = "array" === i.type(o)),
            i.each(n, function (e, t) {
              i.link(t, e === n.length - 1 && r, a && o[e]);
            })
          );
        o =
          "layuicss-" +
          (o = o || n.replace(/^(#|(http(s?)):\/\/|\/\/)|\.|\/|\?.+/g, ""));
        var u = d.getElementById(o);
        return (
          u ||
            (((u = d.createElement("link")).href =
              n + (m.debug ? "?v=" + new Date().getTime() : "")),
            (u.rel = "stylesheet"),
            (u.id = o),
            e.appendChild(u)),
          "complete" === u.__lay_readyState__
            ? t && r(u)
            : N(
                u,
                function () {
                  (u.__lay_readyState__ = "complete"), t && r(u);
                },
                function () {
                  j(n + " load error", "error"), e.removeChild(u);
                }
              ),
          i
        );
      }),
      (r.prototype.addcss = function (e, t, n) {
        return layui.link(m.dir + "css/" + e, t, n);
      }),
      (r.prototype.factory = function (e) {
        if (layui[e])
          return "function" == typeof m.callback[e] ? m.callback[e] : null;
      }),
      (r.prototype.img = function (e, t, n) {
        var r = new Image();
        if (((r.src = e), r.complete)) return t(r);
        (r.onload = function () {
      ...
      (r.prototype.router = r.prototype.hash =
        function (e) {
          var n = {
            ...
            pathname: [],
            search: {},
            hash: ((e = e || v.hash).match(/[^#](#.*$)/) || [])[1] || "",
            href: "",
          };
          return (
            /^#/.test(e) &&
              ((e = e.replace(/^#/, "")),
              (e = (n.href = e).replace(/([^#])(#.*$)/, "$1").split("/") || []),
        ...
        return {
          ...
          search:
            ...
            n.each(t, function (e, t) {
              var n = t.indexOf("="),
                r = n < 0 ? t.substr(0, t.length) : 0 !== n && t.substr(0, n);
              r && (o[r] = 0 < n ? t.substr(n + 1) : null);
            }),
            o),
          hash: n.router(e ? (e.match(/#.+/) || [])[0] || "/" : v.hash),
        };
      }),
      (r.prototype.data = function (e, t, n) {
        if (((e = e || "layui"), (n = n || localStorage), null === t))
          return delete n[e];
        ...
        return (
          "value" in t && (r[t.key] = t.value),
          t.remove && delete r[t.key],
          (n[e] = JSON.stringify(r)),
          t.key ? r[t.key] : r
        );
      }),
        ...
        var n = navigator.userAgent.toLowerCase(),
          ...
          r = {
            os: /windows/.test(n)
              ...
              : void 0,
            ie:
              !!(h.ActiveXObject || "ActiveXObject" in h) &&
      ...
      (r.prototype.each = function (e, n) {
        ...
        if ("function" == typeof n)
          if (this.isArray((e = e || [])))
            for (t = 0; t < e.length && !r(t, e); t++);
          else for (t in e) if (r(t, e)) break;
        return this;
      }),
      (r.prototype.sort = function (e, o, t, n) {
        n = n ? e || [] : JSON.parse(JSON.stringify(e || []));
        if ("object" !== this.type(e) || o) {
  ...
  (r.prototype.onevent = function (e, t, n) {
    ...
    (r.prototype.event = r.event =
      function (e, t, n, r) {
        var o = this,
          ...
          u = i[1] || "",
          c = function (e, t) {
            !1 === (t && t.call(o, n)) && null === a && (a = !1);
          };
        return n === l
          ? (delete (o.cache.event[e] || {})[u], o)
          : r
          ? ((g.event[e] = g.event[e] || {}),
            u
              ? (g.event[e][u] = [r])
              : ((g.event[e][u] = g.event[e][u] || []), g.event[e][u].push(r)),
            this)
          : (layui.each(g.event[e], function (e, t) {
              ("{*}" === u || ("" === e && layui.each(t, c), u && e === u)) &&
                layui.each(t, c);
            }),
            a);
      }),
    ...
    (r.prototype.off = function (e, t) {
      return this.event.call(this, t, e, l);
    }),
    (r.prototype.debounce = function (n, r) {
      var o;
      return function () {
        var e = this,
          t = arguments;
  ...
  var t,
    ...
    n =
      ...
      (p.extend = function () {
        ...
        for (
          n[0] = "object" == typeof n[0] ? n[0] : {}, t = n.length;
          e < t;
          e++
        )
      ...
      (p.hasScrollbar = function () {
        return (
          h.body.scrollHeight >
          (d.innerHeight || h.documentElement.clientHeight)
        );
      }),
      ...
      (p.style = function (t) {
        ...
        if (n)
          return (
            ...
            (e.id =
              "LAY-STYLE-" +
              (t.id || ((n = p.style.index || 0), p.style.index++, "DF-" + n))),
      ...
      (p.position = function (t, e, n) {
        ...
        e &&
          ...
          (r = function (t) {
            return (
              h.body[(t = t ? "scrollLeft" : "scrollTop")] |
              h.documentElement[t]
            );
          }),
          (o = function (t) {
          ...
          "center" === n.align
            ? (l -= (a - t.offsetWidth) / 2)
            : "right" === n.align && (l = l - a + t.offsetWidth),
          (l = l + a + c > o("width") ? o("width") - a - c : l) < c && (l = c),
          (a = i.bottom) + u + c > o() &&
            (i.top > u + c && i.top <= o()
              ? (a = i.top - u - 2 * c)
              : n.allowBottomOut || ((a = o() - u - 2 * c) < 0 && (a = 0))),
          (u = n.position) && (e.style.position = u),
          (s = n.offset ? n.offset[0] : 0),
          (f = n.offset ? n.offset[1] : 0),
          (e.style.left = l + ("fixed" === u ? 0 : r(1)) + s + "px"),
          (e.style.top = a + ("fixed" === u ? 0 : r()) + f + "px"),
          p.hasScrollbar() ||
      ...
      (p.passiveSupported = (function () {
        ...
        try {
          ...
          d.addEventListener("test", null, e),
            d.removeEventListener("test", null, e);
        } catch (n) {}
        return t;
      })()),
      ...
      (p.touchSwipe = function (t, e) {
        var n,
          ...
          c = e,
          a = p(t)[0],
          u = !("preventDefault" in c) || c.preventDefault;
        a &&
          ...
          (e = function (t) {
            1 === t.touches.length &&
              (a.addEventListener(
                "touchmove",
                i,
                !!p.passiveSupported && { passive: !1 }
              ),
              a.addEventListener("touchend", r),
              a.addEventListener("touchcancel", r),
          ...
          (i = function (t) {
            u && t.preventDefault(),
              ...
              Math.abs(n.distanceX) > Math.abs(n.distanceY)
                ? (n.direction = 0 < n.distanceX ? "left" : "right")
                : (n.direction = 0 < n.distanceY ? "up" : "down"),
              c.onTouchMove && c.onTouchMove(t, n);
          }),
          (r = function (t) {
            c.onTouchEnd && c.onTouchEnd(t, n), o();
          }),
          (o = function () {
      ...
      (p.onClickOutside = function (r, o, t) {
        var e =
            (t = t || {}).event ||
            ("onpointerdown" in d ? "pointerdown" : "mousedown"),
          n = t.scope || h,
          u = t.ignore || [],
          i = !("capture" in t) || t.capture,
          t = t.detectIframe;
        function c(t, e, n, i) {
          return (
            t.addEventListener
          ...
          c(
            ...
            function (t) {
              ...
              e &&
                ...
                !(function (t, e) {
                  for (
                    var n = t.target || t.srcElement, i = 0;
                    i < u.length;
                    i++
                  ) {
                    var r = u[i];
                    if ("string" == typeof r)
                      for (
                        var o = h.querySelectorAll(r), c = 0;
                        c < o.length;
                        c++
                      ) {
                        var a = o[i];
            ...
            p.passiveSupported ? { passive: !0, capture: i } : i
          ),
          t &&
            c(d, "blur", function (t) {
              setTimeout(function () {
                h.activeElement &&
                  "IFRAME" === h.activeElement.tagName &&
                  r.contains &&
                  !r.contains(h.activeElement) &&
                  o(t);
              }, 0);
            }),
        ];
        return function () {
          for (var t = 0; t < a.length; t++) a[t] && a[t]();
          a = null;
        };
      }),
...
!(function (e) {
  ...
  var n = {
    ...
    m = function (e, r) {
      return new RegExp(e, r || "g");
    },
    g = function (e, r, t) {
      r = r || {};
      var e =
          "Laytpl " +
          ((r = Object.assign({ errorContext: "" }, r)).type || "") +
          "Error: " +
          e,
        n = r.errorContext;
      return (
        delete r.errorContext,
        "object" == typeof console && console.error(e, "\n", n, "\n", r),
        "function" == typeof t && t(r),
        e
      );
    },
    o = { open: "{{", close: "}}", cache: !0, condense: !0, tagStyle: "" },
    t = function (e, r) {
      var t = this;
      (r = t.config = Object.assign({ template: e }, o, r)),
        (t.vars = Object.assign(
          {
            include: function (e, r) {
              (e = document.getElementById(e)), (e = e ? e.innerHTML : "");
              return e ? t.render(e, r) : "";
            },
          },
          n
        )),
        t.compile(r.template);
    },
    r =
      ((t.prototype.render = function (r, t) {
        var n = this,
          o = n.config,
          c = r ? n.compile(r) : n.compilerCache || n.compile(o.template),
          e = (function () {
            t = t || o.data || {};
            try {
              return c(t);
              ...
              return (
                ...
                g(
                  e,
                  {
                    errorContext: n.extractErrorContext(r, t),
                    template: r,
                    type: "Render",
                  },
                  o.error
        ...
        return o.cache && !r && (n.compilerCache = c), e;
      }),
      (t.prototype.compile = function (e) {
        ...
        var p = function (e, r) {
            ...
            return (
              (r = r || {}).before && e.unshift(r.before),
              r.after && e.push(r.after),
              u(e.join(""))
            );
          },
          r = i ? ["", ""] : ["(?:(?:\\n)*\\s*)", "(?:\\s*?)"],
          f = { before: r[0], after: r[1] },
          s = function (e, r) {
            return (e = (e = i ? e : e.replace(u(l), r ? "" : "\n")).replace(
              /\\(\\|")/g,
              "$1"
            ));
          },
          n = (t.parse = function (e) {
            var n, r, t;
            return (
              (e = e || "") &&
                ((e = (e = (e = i
                  ...
                  p(["!", "", "!"], f),
                  function (e, r) {
                    return (r = r.replace(u(c + "|" + a), function (e) {
                      return e.replace(/(?=.)/g, "\\");
                    }));
                  }
                )),
                (n = function (e) {
                  return ['";', e, '__laytpl__+="'].join("\n");
                }),
                (r = function (e, r, t) {
                  return t && ((r = "-" === r ? "" : "_escape"), (t = s(t, !0)))
                    ? n("__laytpl__+=" + r + "(" + t + ");")
                    : "";
                }),
                (t = function (e, r) {
                ...
                (e =
                  "modern" === o.tagStyle
                    ? (e = (e = e.replace(p(["#"], f), "")).replace(
                        p(["(=|-)"]),
                        r
                      )).replace(p([], f), t)
                    : (e = e.replace(p(["#"], f), t)).replace(
                        p(["(=|-)*"]),
                        r
                      )),
                i || (e = e.replace(u(l), "\\n"))),
          ...
          r = (t.createCompiler = function (e, r) {
            return (
              (r = r || d(e)), new Function("laytpl", "return " + r)(t.vars)
            );
          }),
          d = (t.createBuilder = function (e, r) {
            return (r =
              r ||
              [
                "function(d){",
        ...
        try {
          ...
          return (
            delete t.compilerCache,
            function () {
              return g(
                y,
                {
                  errorContext: t.extractErrorContext(e),
                  template: e,
                  type: "Compile",
                },
                o.error
      ...
      (t.prototype.extractErrorContext = function (e, r) {
        var t = 1,
          o = e.split(/\r?\n/g),
          n =
            ((e = e.replace(/(?=^)/gm, function () {
              return "/*LINE:" + t++ + "*/";
            })),
            this.createBuilder(e)),
          c = n.split(/\r?\n/),
          a = "laytpl.builder.map";
        try {
          n += "\n//# sourceURL=" + a;
          var i = this.createCompiler(e, n);
          r && i(r);
        } catch (l) {
          var e = m(a.replace(/\./g, "\\.") + ":(\\d+)", "i"),
            n = (l.stack.match(e) || [])[1] || 0,
            u = function (e, r) {
              var r = r ? /\/\*LINE:(\d+)\*\/[^*]*$/ : /\/\*LINE:(\d+)\*\//;
              return !(r = (String(c[e - 1]).match(r) || [])[1]) && 0 < e
                ? u(e - 1, !0)
                : r;
            },
            r = u(n - 2);
            ...
            render: function (e, r) {
              ...
              return (
                o.target &&
                  ...
                  (t.innerHTML = e),
                "function" == typeof r ? (r(e), this) : e
              );
            },
            compile: function (e) {
              return (o.template = e), delete n.compilerCache, this;
            },
            error: function (e) {
              return e && (o.error = e), this;
            },
            parse: function (e, r) {
              return this.compile(e).render(r);
            },
          };
        }.call(e);
      });
  (r.extendVars = function (e) {
    Object.assign(n, e);
  }),
    (r.config = r.set =
      function (e) {
          ...
          l = {
            ...
            page: (function () {
              ...
              1 < u &&
                ...
                0 !== r &&
                e.push(
                  '<a class="layui-laypage-first" data-page="1"  title="\u9996\u9875">' +
                    (n.first || 1) +
                    "</a>"
                );
              ...
              return (
                n.pages > r &&
                  ...
                  0 !== r) &&
                  e.push(
                    '<a class="layui-laypage-last" title="\u5c3e\u9875"  data-page="' +
                      n.pages +
                      '">' +
                      (n.last || n.pages) +
                      "</a>"
            ...
            limit:
              ...
              i.join("") + "</select></span>"),
            refresh: [
              '<a data-page="' + n.curr + '" class="layui-laypage-refresh">',
...
!(function (i, D) {
  ...
  var n = i.layui && layui.define,
    ...
    k = function (e) {
      var t,
        ...
        n =
          ((a.index = ++T.index),
          (a.config = lay.extend({}, a.config, T.config, e)),
  ...
  (s.formatArr = function (e) {
        ...
        o.elem[0] &&
          ...
          lay.each(r.format, function (e, t) {
            e = new RegExp(u).test(t)
              ? "\\d{" +
                (new RegExp(u).test(r.format[0 === e ? e + 1 : e - 1] || "")
                  ? /^yyyy|y$/.test(t)
                    ? 4
                    : t.length
                  : /^yyyy$/.test(t)
          ...
          (o.show || e) && r.render(),
          e || r.events(),
          "function" == typeof o.formatToDisplay &&
            (r.isInput(o.elem[0])
              ? r.formatToDisplay(o.elem[0], o.formatToDisplay)
              : (t = r.rangeElem) &&
                (r.formatToDisplay(t[0][0], o.formatToDisplay),
                r.formatToDisplay(t[1][0], o.formatToDisplay))),
          o.value) &&
          o.isInitValue &&
      ...
      var a,
        ...
        p =
          ...
          lay.each(new Array(2), function (e) {
            ...
            var a = lay.elem("div", { class: "layui-laydate-header" }),
              t = [
                ...
                t),
                ((t = lay.elem("div", { class: "laydate-set-ym" })).appendChild(
                  lay.elem("span")
                ),
                t.appendChild(lay.elem("span")),
                t),
                (((t = lay.elem("i", {
          ...
          lay(e).html(
            ...
            (o.range || "datetime" !== o.type || o.fullPanel) &&
              p.push(
                '<span class="' + x + '" title="' + d.preview + '"></span>'
              ),
        ...
        t =
          ...
          f.length &&
            ((f = f.join("")),
            "styleSheet" in p
              ? (p.setAttribute("type", "text/css"), (p.styleSheet.cssText = f))
              : (p.innerHTML = f),
    ...
    (k.prototype.mark = function (t, a) {
      ...
      return (
        e.calendar && "cn" === e.lang && i(n.markerOfChineseFestivals),
        "function" == typeof e.mark
          ? e.mark({ year: a[0], month: a[1], date: a[2] }, i)
          : "object" == typeof e.mark && i(e.mark),
        n
      );
    }),
    ...
    (k.prototype.holidays = function (t, a) {
      ...
      return (
        "function" == typeof e.holidays
          ? e.holidays({ year: a[0], month: a[1], date: a[2] }, i)
          : "array" === layui.type(e.holidays) && i(e.holidays),
        n
      );
    }),
    (k.prototype.cellRender = function (t, e, a) {
      var n = this.config;
      return (
        "function" == typeof n.cellRender &&
          n.cellRender(
            e,
            function (e) {
              "string" == typeof e
                ? lay(t).html(e)
                : "object" == typeof e && lay(t).html("").append(lay(e)[0]);
            },
            { originElem: t, type: a }
          ),
        this
    ...
    (k.prototype.isDisabledYearOrMonth = function (e, t, a) {
      for (
        var n = this,
          i = n.config,
          l = "year" === t ? n.startOfYear(e) : n.startOfMonth(e),
          t = "year" === t ? n.endOfYear(e) : n.endOfMonth(e),
    ...
    (k.prototype.isDisabledDate = function (e, t) {
      ...
      return (
        !!a.disabledDate &&
        "time" !== a.type &&
        ("date" === t.disabledType || "datetime" === t.disabledType) &&
        ((e = new Date(e)).setHours(0, 0, 0, 0),
        "year" === t.type || "month" === t.type
          ? this.isDisabledYearOrMonth(e, t.type, n)
          : a.disabledDate.call(a, e, n))
      );
    }),
    (k.prototype.isDisabledTime = function (e, t) {
      ...
      return (
        !!n.disabledTime &&
        !(
          ("time" !== n.type && "datetime" !== n.type) ||
          ("time" !== t.disabledType && "datetime" !== t.disabledType)
        ) &&
        ((a = function (e, t, a) {
          return function () {
            return (
              -1 !==
              (("function" == typeof t && t.apply(n, a)) || []).indexOf(e)
            );
          };
        }),
        (e = this.systemDate(new Date(e))),
        (i = n.disabledTime.call(n, this.newDate(e), i) || {}),
        "datetime" === t.disabledType
          ? a(e.hours, i.hours)() ||
            a(e.minutes, i.minutes, [e.hours])() ||
            a(e.seconds, i.seconds, [e.hours, e.minutes])()
          : [
              a(e.hours, i.hours),
              a(e.minutes, i.minutes, [e.hours]),
              a(e.seconds, i.seconds, [e.hours, e.minutes]),
    ...
    (k.prototype.calendar = function (e, i, t) {
      ...
      return (
          ...
          (t = lay(t)).removeAttr("class"),
            e < l
              ? ((a = r - l + e),
                ...
                (n = d.getAsYM(s.year, s.month, "sub")))
              : l <= e && e < o + l
              ? ((a = e - l),
                d.rangeLinked || (a + 1 === s.date && t.addClass(M)))
              : ((a = e - o - l),
                t.addClass("laydate-day-next"),
                (n = d.getAsYM(s.year, s.month))),
            n[1]++,
            (n[2] = a + 1),
        ...
        "cn" === a.lang
          ? (lay(c[0])
            ...
            lay(c[1])
              .attr("lay-type", "month")
              .html(s.month + 1 + " \u6708"))
          : (lay(c[0]).attr("lay-type", "month").html(y.month[s.month]),
            lay(c[1]).attr("lay-type", "year").html(s.year)),
        m &&
          (a.range
            ? (!e && "init" === t) ||
              ((d.listYM = [
                [
                  (d.startDate || a.dateTime).year,
                  (d.startDate || a.dateTime).month + 1,
                ],
              ...
              "time" === a.type
                ? d.setBtnStatus(
                    "\u65f6\u95f4",
                    lay.extend({}, d.systemDate(), d.startTime),
                    lay.extend({}, d.systemDate(), d.endTime)
                  )
                : d.setBtnStatus(!0))
        ...
        a.range &&
          "init" === t &&
          (d.rangeLinked
            ? ((n = d.getAsYM(s.year, s.month, i ? "sub" : null)),
              d.calendar(lay.extend({}, s, { year: n[0], month: n[1] }), 1 - i))
            : d.calendar(null, 1 - i)),
        a.range ||
          ...
          d.limit({
            ...
            date: d.systemDate(
              /^(datetime|time)$/.test(a.type) ? new Date() : null
            ),
            index: 0,
            time: u,
      ...
      return (
        ...
        "year" === n
          ...
          : "time" === n &&
            ...
            y.range
              ? s[k] || (s[k] = "startTime" === k ? m : s.endDate)
              : (s[k] = m),
            ...
            r(),
            (e = -1 !== y.format.indexOf("H")),
            (f = -1 !== y.format.indexOf("m")),
            (t = -1 !== y.format.indexOf("s")),
            (a = h.children),
            (o = 0),
        ...
        "year" === n || "month" === n
              ...
              .on("click", function () {
                ...
                lay(this).hasClass(C) ||
                  (s.rangeLinked
                    ...
                    : (m[n] = a),
                  (e = -1 !== ["year", "month"].indexOf(y.type)),
                  (t =
                    "year" === n &&
                    -1 !== ["date", "datetime"].indexOf(y.type)),
                  e || t
                    ? (lay(h)
                        .find("." + M)
                        .removeClass(M),
                      lay(this).addClass(M),
                      (("month" === y.type && "year" === n) || t) &&
                        ((s.listYM[i][0] = a),
                        c && ((i ? s.endDate : m).year = a),
                        s.list("month", i)))
                    : (s.checkDate("limit").calendar(m, i, "init"),
                      s.closeList()),
                  s.setBtnStatus(),
                  !y.range &&
                    y.autoConfirm &&
                    (("month" === y.type && "month" === n) ||
                      ("year" === y.type && "year" === n)) &&
                    s.setValue(s.parse()).done().remove(),
                  s.autoCalendarModel.auto && !s.rangeLinked
                    ? s.choose(lay(g).find("td.layui-this"), i)
                    : s.endState && s.done(null, "change"),
                  lay(s.footer)
                    .find("." + I)
                    .removeClass(C));
              }))
          : ((f = lay.elem("span", { class: L })),
            ...
            layui.device().mobile &&
              D.css({ overflowY: "auto", touchAction: "pan-y" })),
        s
      );
    }),
    (k.prototype.listYM = []),
    ...
    (k.prototype.setBtnStatus = function (e, t, a) {
      ...
      i.range &&
        ...
        n.limit({ date: t, disabledType: "datetime", time: o, rangeType: 0 }) ||
        n.limit({ date: a, disabledType: "datetime", time: o, rangeType: 1 })
          ? r.addClass(C)
      ...
      return (
        "static" !== n.position &&
          ...
          a.isInput(i)
            ...
            : (t = a.rangeElem)
            ? ("array" !== layui.type(e) &&
                (e = e.split(" " + a.rangeStr + " ")),
              t[0].val(e[0] || ""),
              t[1].val(e[1] || ""))
            : (0 === lay(i).find("*").length &&
                ((t =
                  "function" == typeof n.formatToDisplay
                    ? n.formatToDisplay(e)
                    : e),
                lay(i).html(t)),
          ...
          l.rangeLinked &&
            ...
            (a !== r && a !== n) ||
              ((i.rangeLinked ||
                ...
                lay(t).addClass(
                  lay(t).hasClass(y) || lay(t).hasClass(m) ? o : M
                )),
    ...
    (k.prototype.checkPanelDate = function (e, t) {
      var a,
        n = this.config;
      if ("date" === n.type || "datetime" === n.type)
        return (
          (n = 0 === t),
          (e = e.month + 1),
        ...
        i.range
          ? (lay.each(["startTime", "endTime"], function (e, t) {
            ...
            n.endState &&
              ...
              (i.dateTime = lay.extend({}, n.startDate)),
            n.rangeLinked
              ? ((e = n.checkPanelDate(l, t)),
                (o = lay.extend({}, l)),
                (d = r || (e && e.needFullRender) ? "init" : null),
                (e = e ? e.index : t),
                n.calendar(o, e, d))
              ...
              if (lay(t).hasClass(C))
                return (
                  "time" === n.type
                    ? a.startTime &&
                      a.endTime &&
                      a.newDate(a.startTime) > a.newDate(a.endTime)
                    : a.startDate &&
                      a.endDate &&
                      a.newDate(
                        lay.extend({}, a.startDate, a.startTime || {})
                      ) > a.newDate(lay.extend({}, a.endDate, a.endTime || {}))
                )
                  ? a.hint(
                      "time" === n.type
        ...
        prevMonth: function () {
          ...
          i.rangeLinked
            ? ((t = i.panelYM[0]),
              ...
              (e = lay.extend({}, l.dateTime, i.panelYM[0], {
                year: t[0],
                month: t[1],
              })),
...
!(function (e, t) {
  ...
  function De() {
    ...
    function r(e, t) {
      return (
        n.push(e + " ") > w.cacheLength && delete r[n.shift()], (r[e + " "] = t)
      );
    }
    return r;
  }
    ...
    return (
      e != E &&
        ...
        (w.find.CLASS = function (e, t) {
          if ("undefined" != typeof t.getElementsByClassName && k)
  ...
  ((w = S.expr =
    {
      ...
      pseudos: {
        ...
        checked: function (e) {
          return (
            (x(e, "input") && !!e.checked) || (x(e, "option") && !!e.selected)
          );
        },
        selected: function (e) {
  ...
  (S.Callbacks = function (r) {
    ...
    S.extend({
                    ...
                    t = function () {
                      ...
                      if (!(o < l)) {
                        ...
                        (t =
                          ...
                          v(t)
                            ? u
                              ? t.call(e, c(l, s, et, u), c(l, s, tt, u))
                              : (l++,
                                t.call(
                                  e,
                                  c(l, s, et, u),
                                  c(l, s, tt, u),
                                  c(l, s, et, s.notifyWith)
                                ))
                            : (a !== et && ((n = undefined), (r = [e])),
                              (u || s.resolveWith)(n, r));
                      }
                    },
                    i = u
                      ...
                      : function () {
                          try {
                            ...
                            S.Deferred.exceptionHook &&
                              S.Deferred.exceptionHook(e, i.error),
                              l <= o + 1 &&
                                (a !== tt && ((n = undefined), (r = [e])),
                                s.rejectWith(n, r));
                          }
                        };
                  o
                    ...
                    : (S.Deferred.getErrorHook
                        ? (i.error = S.Deferred.getErrorHook())
                        : S.Deferred.getStackHook &&
                          (i.error = S.Deferred.getStackHook()),
                      T.setTimeout(i));
                };
              }
              return S.Deferred(function (e) {
                o[0][3].add(c(0, e, v(r) ? r : et, e.notifyWith)),
                  o[1][3].add(c(0, e, v(t) ? t : et)),
                  o[2][3].add(c(0, e, v(n) ? n : tt));
              }).promise();
            },
            promise: function (e) {
      ...
      when: function (e) {
        ...
        if (
          n <= 1 &&
          (nt(e, o.done(s(t)).resolve, o.reject, !n),
      ...
      (yt.getRootNode &&
        (mt = function (e) {
          return (
            ...
            e.getRootNode(vt) === e.ownerDocument
          );
        }),
      function (e, t) {
        return (
          "none" === (e = t || e).style.display ||
          ("" === e.style.display && mt(e) && "none" === S.css(e, "display"))
        );
      });
  function bt(e, t, n, r) {
    var i,
  ...
  function At(e, t, n, r, i) {
    ...
    for (c.textContent = "", d = 0; (o = f[d++]); )
      if (r && -1 < S.inArray(o, r)) i && i.push(o);
        ...
        ((u = mt(o)), (s = y(c.appendChild(o), "script")), u && kt(s), n)
      )
  ...
  function Lt(e, t, n, r, i, o) {
    var s, a;
    if ("object" == typeof t) {
      for (a in ("string" != typeof n && ((r = r || n), (n = undefined)), t))
        Lt(e, a, n, r, t[a], o);
      return e;
    }
    if (
    ...
    special: {
      ...
      click: {
        setup: function (e) {
          e = this || e;
          return (
            Ct.test(e.type) && e.click && x(e, "input") && Ht(e, "click", !0),
            !1
          );
        },
        trigger: function (e) {
  ...
  function Rt(e, t) {
    return (
      (x(e, "table") &&
        x(11 !== t.nodeType ? t : t.firstChild, "tr") &&
  ...
  function $t(n, r, i, o) {
    ...
    var e,
      ...
      p = r[0],
      h = v(p);
    if (h || (1 < f && "string" == typeof p && !g.checkClone && Pt.test(p)))
  ...
  function Bt(e, t, n) {
    for (var r, i = t ? S.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
      n || 1 !== r.nodeType || S.cleanData(y(r)),
        r.parentNode &&
          (n && mt(r) && kt(y(r, "script")), r.parentNode.removeChild(r));
    return e;
  }
  S.extend({
      ...
      if (
        ...
        for (s = y(c), r = 0, i = (o = y(e)).length; r < i; r++)
          (a = o[r]),
            (u = s[r]),
            (l = void 0),
            "input" === (l = u.nodeName.toLowerCase()) && Ct.test(a.type)
              ? (u.checked = a.checked)
              : ("input" !== l && "textarea" !== l) ||
  ...
  function tn() {
    ...
    H &&
      ...
      yt.appendChild(Yt).appendChild(H),
      (e = T.getComputedStyle(H)),
      (_t = "1%" !== e.top),
      (Gt = 12 === nn(e.marginLeft)),
      (H.style.right = "60%"),
      (Ut = 36 === nn(e.right)),
      (zt = 36 === nn(e.width)),
      (H.style.position = "absolute"),
      (Xt = 12 === nn(H.offsetWidth / 3)),
      yt.removeChild(Yt),
      (H = null));
  }
  function nn(e) {
  ...
  function rn(e, t, n) {
    ...
    return (
      (n = n || Qt(e)) &&
        ...
        "" !== (r = i ? r && (r.replace(ee, "$1") || undefined) : r) ||
          mt(e) ||
          (r = S.style(e, t)),
        !g.pixelBoxStyles()) &&
        Jt.test(r) &&
  ...
  function hn(e, t, n, r, i, o) {
    ...
    for (; s < 4; s += 2)
      "margin" === n && (l += S.css(e, n + gt[s], !0, i)),
        r
          ? ("content" === n && (u -= S.css(e, "padding" + gt[s], !0, i)),
            "margin" !== n &&
              (u -= S.css(e, "border" + gt[s] + "Width", !0, i)))
          : ((u += S.css(e, "padding" + gt[s], !0, i)),
            "padding" !== n
              ? (u += S.css(e, "border" + gt[s] + "Width", !0, i))
              : (a += S.css(e, "border" + gt[s] + "Width", !0, i)));
    return (
      !r &&
        0 <= o &&
        (u +=
  ...
  function P(i, e, t) {
    ...
    return (
      ...
      S.fx.timer(S.extend(p, { elem: i, anim: h, queue: h.opts.queue })),
      h
    );
  }
        ...
        if ((u = !S.isEmptyObject(t)) || !S.isEmptyObject(d))
          ...
          d))
            u ||
              ...
              h && Tt([e], !0),
              f.done(function () {
                for (r in (h || Tt([e]), m.remove(e, "fxshow"), d))
                  S.style(e, r, d[r]);
              })),
              (u = Cn(h ? g[r] : 0, r, f)),
              r in g ||
            ...
            return "undefined" == typeof e.getAttribute
              ...
              : ((1 === o && S.isXMLDoc(e)) ||
                  (i =
                    ...
                    (S.expr.match.bool.test(t) ? Sn : undefined)),
                n !== undefined
                  ? null === n
            ...
            get: function (e) {
              for (
                ...
                if (
                  ((t = n[a]).selected || a === r) &&
                  !t.disabled &&
                  (!t.parentNode.disabled || !x(t.parentNode, "optgroup"))
                ) {
      ...
      (S.extend(S.event, {
        trigger: function (e, t, n, r) {
          ...
          if (
            ...
            if (!r && !l.noBubble && !X(n)) {
              for (
                s = l.delegateType || d, Pn.test(s + d) || (h = h.parentNode);
                h;
                h = h.parentNode
              )
                f.push(h), (o = h);
            ...
            return (
              ...
              r ||
                ...
                (a &&
                  ...
                  ((o = n[a]) && (n[a] = null),
                  (S.event.triggered = d),
                  e.isPropagationStopped() && c.addEventListener(d, Mn),
                  n[d](),
                  e.isPropagationStopped() && c.removeEventListener(d, Mn),
    ...
    S.extend({
      ...
      ajax: function (e, t) {
        ...
        if (
          ...
          h.hasContent
            ...
            : ((e = h.url.slice(l.length)),
              h.data &&
                ...
                ((l += (On.test(l) ? "&" : "?") + h.data), delete h.data),
              !1 === h.cache &&
                ((l = l.replace(_n, "$1")),
                (e = (On.test(l) ? "&" : "?") + "_=" + Hn.guid++ + e)),
              (h.url = l + e)),
          h.ifModified &&
            (S.lastModified[l] &&
          ...
          if (h.beforeSend && (!1 === h.beforeSend.call(g, b, h) || d))
            return b.abort();
          if (
            ((s = "abort"),
            v.add(h.complete),
            ...
            if (((b.readyState = 1), p && y.trigger("ajaxSend", [b, h]), d))
              return b;
            h["async"] &&
              0 < h.timeout &&
        ...
        function a(e, t, n, r) {
          ...
          d ||
            ...
            b.statusCode(x),
            (x = undefined),
            p && y.trigger(r ? "ajaxSuccess" : "ajaxError", [b, h, r ? i : o]),
            v.fireWith(g, [b, a]),
            p &&
    ...
    or =
      ...
      S.ajaxPrefilter("json jsonp", function (e, t, n) {
        ...
        if (s || "jsonp" === e.dataTypes[0])
          return (
            ...
            n.always(function () {
              i === undefined ? S(T).removeProp(r) : (T[r] = i),
      ...
      S.each(["top", "left"], function (e, n) {
        S.cssHooks[n] = on(g.pixelPosition, function (e, t) {
          if (t)
            return (t = rn(e, n)), Jt.test(t) ? S(e).position()[n] + "px" : t;
        });
      }),
...
layui.define(["jquery", "lay"], function (e) {
  ...
  e("component", function (a) {
    var t = (a = f.extend(!0, { isDeepReload: !1 }, a)).name,
      c = "lay-" + t + "-id",
      d = {
        config: {},
        ...
        set: function (e) {
          return f.extend(!0, this.config, e), this;
        },
        on: function (e, n) {
      ...
      l = function () {
        ...
        return (
          "function" == typeof a.extendsInstance &&
            f.extend(!0, e, a.extendsInstance.call(n)),
          e
        );
      },
      n = function (e) {
        var n = this;
        (n.index = ++d.index),
          (n.config = f.extend(!0, {}, n.config, d.config, e)),
          "function" == typeof a.beforeInit && a.beforeInit.call(n, n.config),
          n.init();
      };
    return (
      (n.prototype.config = a.config),
      (n.prototype.reload = function (e, n) {
        var t = this;
        (t.config = f.extend(a.isDeepReload, {}, t.config, e)), t.init(!0, n);
      }),
      (n.prototype.init = function (e, n) {
        ...
        return 1 < r.length
          ? (layui.each(r, function () {
              d.render(f.extend({}, o, { elem: this }));
            }),
            i)
          : ((t = u.options(r[0])),
            e ? (o = i.config = f.extend(t, o)) : f.extend(o, t),
            !e && r.attr(c)
              ? (t = d.getInst(r.attr(c)))
                ? t.reload(o, n)
                : void 0
              : ((o.elem = f(o.elem)),
                (o.id = u.hasOwn(o, "id") ? o.id : r.attr("id") || i.index),
                (l.that[o.id] = i),
                "function" == typeof a.beforeRender &&
                  a.beforeRender.call(i, o),
                "function" == typeof i.render &&
                  ((d.cache.id[o.id] = null), r.attr(c, o.id), i.render(e)),
                void ("function" == typeof i.events && i.events())));
      }),
      (n.prototype.render = a.render),
      (n.prototype.events = a.events),
      (n.prototype.cache = function (e, n, t) {
      ...
      (d.getAllInst = function () {
        return l.that;
      }),
      (d.removeInst = function (e) {
        delete l.that[e], delete d.cache.id[e];
      }),
      (d.cache = { id: {} }),
      (d.Class = n),
      (d.reload = function (e, n) {
        e = d.getInst(e);
    ...
    v = {
      ...
      confirm: function (e, t, i, n) {
        ...
        return (
          a && ((n = i), (i = t)),
          v.open(
            h.extend({ content: e, btn: f.btn, yes: i, btn2: n }, a ? {} : t)
          )
        );
      },
      msg: function (e, t, i) {
    ...
    i =
                ...
                a.closeBtn &&
                  n.push(
                    '<span class="layui-icon layui-icon-close ' +
                      [
                        u[7],
                        u[7] + (a.title ? a.closeBtn : 4 == a.type ? "1" : "2"),
                      ].join(" ") +
                      '"></span>'
                  ),
                n.join("")) +
      ...
      (t.pt.creat = function () {
        ...
        if (o.id && h("." + u[0]).find("#" + o.id)[0])
          ...
          switch (
            ...
            case 4:
              r || (o.content = [o.content, "body"]),
                ...
                (o.content =
                  o.content[0] + '<i class="layui-layer-TipsG"></i>'),
                delete o.title,
                (o.tips = "object" == typeof o.tips ? o.tips : [o.tips, !0]),
          ...
          a
            ...
            2 == o.type &&
              6 == v.ie &&
              a.layero.find("iframe").attr("src", d[0]),
            4 == o.type
              ? a.tips()
              : (a.offset(),
                parseInt(
                  f.getStyle(document.getElementById(u.MOVE), "z-index")
                ) ||
      ...
      (t.pt.auto = function (e) {
        var t = this.config,
          i = h("#" + u[0] + e),
          n =
            (("" === t.area[0] || "auto" === t.area[0]) &&
              0 < t.maxWidth &&
              (v.ie && v.ie < 8 && t.btn && i.width(i.innerWidth()),
      ...
      (t.pt.tips = function () {
        ...
        e.tips[1] || o.remove(),
          ...
          (a.where = [
            ...
            function () {
              (a.tipLeft = a.left + a.width + 10),
                (a.tipTop =
                  a.top - (0.75 * a.height < 21 ? 21 - 0.5 * a.height : 0)),
          ...
          1 === n
            ...
            : 2 === n
            ? 0 < g.width() - (a.left + a.width + i[0] + 16) || a.where[3]()
            : 3 === n
            ? 0 < a.top - g.scrollTop() + a.height + i[1] + 16 - g.height() &&
              a.where[0]()
          ...
          f.docEvent ||
            (e
              ...
              .on("mouseup", function (e) {
                var t, i;
                f.eventMoveElem &&
                  ((i = (t = f.eventMoveElem.data(l[0]) || {}).config),
                  f.eventMoveElem.removeData(l[0]),
                  delete f.eventMoveElem,
                  f.moveElem.hide(),
                  i.moveEnd) &&
                  i.moveEnd(t.layero),
                  f.eventResizeElem &&
                    (f.eventResizeElem.removeData(l[1]),
      ...
      (t.pt.callback = function () {
        ...
        n.openLayer(),
            ...
            .on("click", function () {
              ...
              t.attr("disabled") ||
                (o.btnAsync
                    ...
                    e
                      ? f.promiseLikeResolve(e.call(o, n.index, a, n)).then(
                          ...
                          function (e) {
                            e !== m &&
                              p.console &&
                              p.console.error("layer error hint: " + e);
                          }
                        )
                      : v.close(n.index))
                  : 0 === i
                  ...
                  : !1 !==
                      (o["btn" + (i + 1)] &&
                        o["btn" + (i + 1)](n.index, a, n)) && v.close(n.index));
            }),
          ...
          o.beforeEnd &&
            (f.beforeEnd[n.index] = h.proxy(o.beforeEnd, o, a, n.index, n));
      }),
      (f.reselect = function () {
      ...
      (f.restScrollbar = function (t) {
        u.html.css("overflow") &&
          0 ===
            h("." + u[0]).filter(function () {
              var e = h(this);
              return (
                !1 === (e.data("config") || {}).scrollbar &&
                "min" !== e.data("maxminStatus") &&
                e.attr("times") !== String(t)
              );
            }).length &&
          u.html.css("overflow", "");
      }),
      ...
      (v.min = function (e, t) {
        ...
        "min" !== c &&
          ...
          (o = (a = "string" == typeof (o = l.attr("minLeft")))
            ? o
            : 181 * f.minStackIndex + "px"),
          (s = l.css("position")),
          (r = {
            width: 180,
            height: n,
          ...
          f.record(l),
          0 < f.minStackArr.length &&
            ((o = f.minStackArr[0]), f.minStackArr.shift()),
          parseFloat(o) + 180 > g.width() &&
            (o =
              g.width() -
              180 -
              ((f.minStackArr.edgeIndex = f.minStackArr.edgeIndex || 0),
              (f.minStackArr.edgeIndex += 3))) < 0 &&
            (o = 0),
          t.minStack &&
            ((r.left = o),
            (r.top = g.height() - n),
          ...
          v.style(e, r, !0),
          i.hide(),
          "page" === l.attr("type") && l.find(u[4]).hide(),
          f.restScrollbar(e),
          c.hide());
      }),
      (v.restore = function (e) {
        ...
        t.removeData("maxminStatus"),
          ...
          r !== m &&
            (n.removeData(l),
            (o === f.type[2] ? n.children("iframe") : n).css({ height: r })),
          i.show();
      }),
      (v.full = function (t) {
        var i = h("#" + u[0] + t),
        ...
        l[0] &&
          ((t = function () {
            var o =
              ...
              e = function () {
                ...
                "function" == typeof f.end[s] && f.end[s](),
                  ...
                  "function" == typeof r && r(),
                  f.events.resize[s] &&
                    (g.off("resize", f.events.resize[s]),
                    delete f.events.resize[s]);
              },
              t = h("#" + u.SHADE + s);
            (v.ie && v.ie < 10) || !i.isOutAnim
              ...
              6 == v.ie && f.reselect(),
              f.restScrollbar(s),
              "string" == typeof l.attr("minLeft") &&
                (f.minStackIndex--, f.minStackArr.push(l.attr("minLeft"))),
              (v.ie && v.ie < 10) || !i.isOutAnim
                ? e()
                : setTimeout(function () {
                    e();
          ...
          d || "function" != typeof f.beforeEnd[s]
      ...
      (v.closeLast = function (i, e) {
        var t,
          n = [],
          a = h.isArray(i);
        h("string" == typeof i ? ".layui-layer-" + i : ".layui-layer").each(
          function (e, t) {
            t = h(t);
            if (
              (a && -1 === i.indexOf(t.attr("type"))) ||
              "none" === t.css("display")
            )
              return !0;
      ...
      if ((n = h.extend(!0, { toolbar: !0, footer: !0 }, n)).photos) {
          ...
          if (
            ...
            e ||
              c.on("click", n.img, function () {
                ...
                v.photos(
                  h.extend(n, {
                    photos: { start: e, data: o, tab: n.tab },
                    full: n.full,
                  }),
                  !0
                );
        ...
        (s.imgprev = function (e) {
          ...
          (s.imgnext = function (e, t) {
            s.imgIndex++,
              (s.imgIndex > o.length && ((s.imgIndex = 1), t)) || s.tabimg(e);
          }),
          (s.keyup = function (e) {
            var t;
            s.end ||
              ...
              37 === t
                ...
                : 39 === t
                ? s.imgnext(!0)
                : 27 === t && v.close(s.index));
          }),
          (s.tabimg = function (e) {
            if (!(o.length <= 1))
              return (
                (i.start = s.imgIndex - 1), v.close(s.index), v.photos(n, !0, e)
              );
          }),
          ...
          (s.getTransform = function (e) {
            var t = [],
              ...
              e = e.scale;
            return (
              s.isNumber(i) && 0 !== i && t.push("rotate(" + i + "deg)"),
            ...
            s.main.find(".layui-layer-photos-prev").on("click", function (e) {
              ...
              e.off("click").on("click", "*[toolbar-event]", function () {
                ...
                switch (e.attr("toolbar-event")) {
                  case "rotate":
                    (s.image.rotate =
                      ((s.image.rotate || 0) + Number(e.attr("data-option"))) %
                      360),
                      s.imgElem.css({ transform: s.getTransform(s.image) });
                    break;
                  case "scalex":
              ...
              (p.layui || p.lay) &&
                ...
                (o = function (e, t) {
                  var i = Date.now() - t.timeStart,
                    i = t.distanceX / i,
                    n = g.width() / 3;
                  (0.25 < Math.abs(i) || Math.abs(t.distanceX) > n) &&
                    ("left" === t.direction
                      ? s.imgnext(!0)
                      : "right" === t.direction && s.imgprev(!0));
                }),
  ...
  var s = layui.$,
    ...
    e = {
      fixbar: function (i) {
        ...
        layui.each(i.bars, function (t, e) {
          ...
          n
            ...
            "top" === e.type && (n.addClass("layui-fixbar-top"), (r = n)),
            l.append(n);
        }),
          u.find("." + o).remove(),
        ...
        var r = arguments,
          ...
          a =
            ...
            (function u() {
              ...
              return (
                1 < r.length && (n = [n.d, n.h, n.m, n.s]),
                (o.timer = setTimeout(function () {
                  e.setTime(e.getTime() + 1e3), (i.now = e), a();
                }, 1e3)),
                "function" == typeof i.clock && i.clock(n, o),
                t <= 0 &&
                  (clearTimeout(o.timer), "function" == typeof i.done) &&
                  i.done(n, o),
                u
              );
            })());
      ...
      timeAgo: function (t, e) {
        ...
        return 26784e5 < r
          ? ((r = new Date(t)),
            (i[0][0] = n.digit(r.getFullYear(), 4)),
            (i[0][1] = n.digit(r.getMonth() + 1)),
            (i[0][2] = n.digit(r.getDate())),
            e ||
              ((i[1][0] = n.digit(r.getHours())),
              (i[1][1] = n.digit(r.getMinutes())),
              (i[1][2] = n.digit(r.getSeconds()))),
            i[0].join("-") + " " + i[1].join(":"))
          : 864e5 <= r
          ? ((r / 1e3 / 60 / 60 / 24) | 0) + " \u5929\u524d"
          : 36e5 <= r
        ...
        return null === t || "" === t
          ...
          : ((r =
            ...
            (t = (function (t) {
              ...
              if (!isNaN(t))
                return new Date("string" == typeof t ? parseInt(t) : t);
      ...
      toVisibleArea: function (t) {
        ...
        (t = s.extend({ margin: 160, duration: 200, type: "y" }, t))
          ...
          t.thisElem[0] &&
          ((u = t.thisElem),
          (i = (o = "y" === t.type) ? "top" : "left"),
          (r = (e = t.scrollElem)[(n = o ? "scrollTop" : "scrollLeft")]()),
          (o = e[o ? "height" : "width"]()),
          (a = e.offset()[i]),
          (c = {}),
          (u = u.offset()[i] - a) > o - t.margin || u < t.margin) &&
          ((c[n] = u - o / 2 + r), e.animate(c, t.duration));
      },
      on: function (i, r, t) {
        "object" == typeof i &&
          ((t = r || {}), (r = i), (i = t.attr || "lay-on"));
        var e,
          n = ((t = s.extend(
            { elem: "body", trigger: "click" },
            "object" == typeof t ? t : { trigger: t }
          )).elem = s(t.elem)),
          o = "[" + i + "]",
          a = "UTIL_ON_DATA";
        if (n[0])
          return (
            n.data(a) || n.data(a, { events: {} }),
            (a = n.data(a)),
            (e = i + "_" + t.trigger),
            (r = a.events[e] = s.extend(!0, a.events[e], r)),
            (e = t.trigger + ".lay_util_on"),
            n.off(e, o),
            n.on(e, o, function (t) {
              var e = s(this),
                n = e.attr(i);
...
layui.define(["jquery", "laytpl", "lay", "util"], function (e) {
  ...
  var n,
    ...
    m = layui.laytpl,
    p = layui.util,
    l = (layui.hint(), layui.device().mobile ? "touchstart" : "mousedown"),
    r = "dropdown",
  ...
  (T.prototype.config = {
    ...
    (T.prototype.init = function (e, i) {
      ...
      return 1 < a.length
        ? (layui.each(a, function () {
            h.render(c.extend({}, n, { elem: this }));
          }),
          t)
        : (c.extend(n, lay.options(a[0])),
          !e && a.attr(y)
            ? (e = g.getThis(a.attr(y)))
              ? e.reload(n, i)
              : void 0
            : ((n.elem = c(n.elem)),
              (n.target = c("body")),
              (n.id = "id" in n ? n.id : a.attr("id") || t.index),
              (g.that[n.id] = t),
              a.attr(y, n.id),
              (n.customName = c.extend({}, h.config.customName, n.customName)),
              "hover" === n.trigger && (n.trigger = "mouseenter"),
              (n.show ||
                ("reloadData" === i &&
                  t.mainElem &&
                  n.target.find(t.mainElem.get(0)).length)) &&
                t.render(i),
              void t.events()));
    }),
    (T.prototype.render = function (e) {
      var i,
          ...
          return (
            layui.each(e, function (e, i) {
              var t,
                ...
                o =
                  ((l = p.escape(i[s.title])),
                  (o = i.templet || d.templet),
                  (l = o
                    ? "function" == typeof o
                      ? o(i)
                      : m(o).render(i)
              ...
              ("-" === l || i[s.title] || i[s.id] || n) &&
                ...
                n &&
                  ...
                  (t = c("<ul></ul>")),
                  "parent" === l
                    ? (a.append(u(t, i[s.children])), o.append(a))
                    : o.append(u(t, i[s.children]))),
                r.append(o));
            }),
            r
          );
        ...
        n =
          d.content ||
          ((n = c('<ul class="layui-menu layui-dropdown-menu"></ul>')),
          0 < d.data.length
            ? u(n, d.data)
            : n.html(
                '<li class="layui-menu-item-none">\u6682\u65e0\u6570\u636e</li>'
              ),
          n),
        a = g.findMainElem(d.id);
      "reloadData" === e && a.length
        ? (i = o.mainElem = a).html(n)
        : ((i = o.mainElem = c(t)).append(n),
          i.addClass(d.className),
        ...
        o.position(),
        (h.thisId = d.id),
        i.find(".layui-menu").on(l, function (e) {
          layui.stope(e);
        }),
        i.find(".layui-menu li").on("click", function (e) {
          ...
          t.disabled ||
            (n && !a) ||
            "-" === t.type ||
            (!1 === ("function" == typeof d.click ? d.click(t, i, e) : null) ||
              n ||
              o.remove(),
            layui.stope(e));
        }),
    ...
    (T.prototype.remove = function (e) {
      ...
      var i = g.getThis(e);
      i &&
        ((i = i.config), (e = g.findMainElem(e))[0]) &&
        (e.prev("." + k).remove(),
        e.remove(),
        i.elem.removeData(f),
        delete h.thisId,
        "function" == typeof i.close) &&
        i.close(i.elem);
    }),
    ...
    (T.prototype.events = function () {
      ...
      t.thisEventElem && t.thisEventElem.off(e),
        (t.thisEventElem = n.elem),
        n.elem.off(e).on(e, function (e) {
          ...
          a
            ? i ||
              (g.timer = setTimeout(function () {
                t.render();
              }, t.normalizedDelay().show))
            : n.closeOnClick && i && "click" === n.trigger
            ? t.remove()
            : t.render(),
            e.preventDefault();
        }),
    ...
    (g.spread = function (e, i) {
      ...
      t.is(":animated") ||
        (n
          ? (e.removeClass(o).addClass(d), t.hide().stop().slideDown(200, a))
          : (t.stop().slideUp(200, a), e.removeClass(d).addClass(o)),
        n &&
          i &&
          ((t = e.siblings("." + d)).children("ul").stop().slideUp(200, a),
    ...
    lay(i).on(
        ...
        if (h.thisId) {
          ...
          if (i) {
            var t = i.config,
              ...
              n =
                !(n || a) &&
                (t.elem[0] === e.target || t.elem.find(e.target)[0]),
              a =
                i.mainElem &&
                (e.target === i.mainElem[0] || i.mainElem.find(e.target)[0]);
            if (!n && !a) {
              if (
                ("touchstart" === e.type &&
                  t.elem.data(f) &&
                  c(e.target).hasClass(k) &&
                  e.preventDefault(),
                "function" == typeof t.onClickOutside)
              )
      ...
      !!lay.passiveSupported && { passive: !1 }
    ),
    n.on("blur", function (e) {
      var i;
      h.thisId &&
        (i = g.getThis(h.thisId)) &&
        i.config.elem.data(f) &&
        setTimeout(function () {
          if (
            document.activeElement &&
            ...
            i.mainElem &&
            i.mainElem[0] &&
            i.mainElem[0].contains &&
            !i.mainElem[0].contains(document.activeElement)
          ) {
            if ("function" == typeof i.config.onClickOutside)
              if (!1 === i.config.onClickOutside(e.originalEvent)) return;
            i.remove();
          }
        }, 0);
    }),
    ...
    i.on("click", t, function (e) {
      ...
      i.hasClass("layui-menu-item-divider") ||
        ...
        i.addClass(u),
        i.parents("." + w).addClass(E),
        (o.title = o.title || c.trim(i.children("." + v).text())),
        layui.event.call(this, r, "click(" + a + ")", o));
    }),
    i.on("click", t + b, function (e) {
      var i = c(this),
        ...
        i =
          "string" ==
          typeof i.parents(".layui-menu").eq(0).attr("lay-accordion");
      ...
      .on("mouseenter", t, function (e) {
        ...
        t[0] &&
          ((i = t[0].getBoundingClientRect()).right > n.width() &&
            (t.addClass(x), (i = t[0].getBoundingClientRect()).left < 0) &&
            t.removeClass(x),
          i.bottom > n.height()) &&
...
layui.define(["jquery", "lay"], function (e) {
  ...
  var x = layui.$,
    ...
    t = function (e) {
      var t = this;
      (t.index = ++m.index),
        (t.config = x.extend({}, t.config, m.config, e)),
        t.render();
    };
  (t.prototype.config = {
    type: "default",
    ...
    (t.prototype.render = function () {
      ...
      x.extend(a, b.options(e[0])),
        ...
        a.range
          ? ((a.value =
              "object" == typeof a.value ? a.value : [a.min, a.value]),
            ...
            (l =
              (s = ((a.value[1] - a.min) / (a.max - a.min)) * 100) - i + "%"),
            (i += "%"),
            (s += "%"))
          : ("object" == typeof a.value &&
              (a.value = Math.min.apply(null, a.value)),
        ...
        i =
          ...
          (a.tips
            ? '<div class="' +
              L +
              '" ' +
              (a.tipsAlways ? "" : 'style="display:none;"') +
              "></div>"
            : "") +
      ...
      function p(e) {
        ...
        return (
          (("vertical" === a.type
            ? t - e.parent()[0].offsetTop - i.height()
            : e.parent()[0].offsetLeft) /
            t) *
          100
        );
      }
      function v(e) {
        "vertical" === a.type
          ...
          : n.elemTemp
              .find("." + L)
              .css({ left: e + "%", display: "inline-block" });
      }
      a.input &&
        !a.range &&
        ((e = x(
        ...
        a.disabled
          ? (n.elemTemp.addClass(f), n.elemTemp.find("." + M).addClass(f))
          : n.slide(),
        a.tips &&
          (a.tipsAlways
            ...
            : n.elemTemp
                ...
                .on("mouseout", function () {
                  clearTimeout(t),
                    a.tipsAlways ||
                      n.elemTemp.find("." + L).css("display", "none");
                }));
    }),
    (t.prototype.slide = function (e, t, i) {
        ...
        h = function (e, t, i) {
          (e =
            (e =
              100 <
              (e =
                100 < Math.ceil(e) * m ? Math.ceil(e) * m : Math.round(e) * m)
                ? 100
                : e) < 0
              ? 0
              : e),
            v.eq(t).css("vertical" === c.type ? "bottom" : "left", e + "%");
          var n,
            a = y(v[0].offsetLeft),
            ...
            l =
              ("vertical" === c.type
                ? d.find("." + T).css({ height: a + "%", bottom: s + "%" })
                : d.find("." + T).css({ width: a + "%", left: s + "%" }),
          ...
          (r = l),
            ...
            c.range &&
              (n = [v.eq(0).data("value"), v.eq(1).data("value")])[0] > n[1] &&
              n.reverse(),
            (u.value = c.range ? n : l),
      ...
      if ("set" === e)
        return h((((t - c.min) / (c.max - c.min)) * 100) / m, i, "done");
      d.find("." + M).each(function (o) {
        var r = x(this);
        r.on("mousedown touchstart", function (e) {
          "touchstart" === (e = e || window.event).type &&
          ...
          var t,
            ...
            n,
            a,
            l = r.parent()[0].offsetLeft,
            s = e.clientX;
          "vertical" === c.type &&
            ((l = p() - r.parent()[0].offsetTop - v.height()), (s = e.clientY));
          (t = r),
            (i = function (e) {
              ...
              var t =
                  l + ("vertical" === c.type ? s - e.clientY : e.clientX - s),
                t =
                  (((t = (t = t < 0 ? 0 : t) > p() ? p() : t) / p()) * 100) / m;
              h(t, o),
                r.addClass(Y),
                d.find("." + L).show(),
                e.preventDefault();
        ...
        d.on("click", function (e) {
          ...
          !t.is(event.target) &&
            ...
            ((i =
              (((t =
                (t =
                  (t =
                    "vertical" === c.type
                      ? p() - e.clientY + i.offset().top - x(window).scrollTop()
                      : e.clientX - i.offset().left - x(window).scrollLeft()) <
                  0
                    ? 0
                    : t) > p()
                  ? p()
            ...
            (t = c.range
              ? "vertical" === c.type
                ? Math.abs(t - parseInt(x(v[0]).css("bottom"))) >
                  Math.abs(t - parseInt(x(v[1]).css("bottom")))
                  ? 1
                  : 0
      ...
      var n = function () {
        var e = this.value,
          e =
            ((e =
              (e = (e = isNaN(e) ? 0 : e) < c.min ? c.min : e) > c.max
                ? c.max
                : e),
            ((((this.value = e) - c.min) / (c.max - c.min)) * 100) / m);
        h(e, 0, "done");
      };
      o.children("." + E)
        .children("input")
      ...
      return function () {
        ...
        return {
          setValue: function (e, t) {
            return (
              (e = (e = e > n.max ? n.max : e) < n.min ? n.min : e),
              (n.value = e),
              i.slide("set", e, t || 0)
            );
          },
...
layui.define(["jquery", "lay"], function (e) {
  ...
  var x = layui.$,
    ...
    s = function (e) {
      (this.index = ++r.index),
        (this.config = x.extend({}, this.config, r.config, e)),
        this.render();
    };
  (s.prototype.config = {
    color: "",
    ...
    (s.prototype.renderPicker = function () {
      ...
      x(c)[0] && x(c).data("index") == e.index
        ? e.removePicker(s.thisElemInd)
        : (e.removePicker(s.thisElemInd), x("body").append(n)),
        (r.thisId = i.id),
    ...
    (s.prototype.removePicker = function (e) {
      ...
      return (
        e[0] &&
          (e.remove(), delete r.thisId, "function" == typeof i.close) &&
          i.close(this.color),
        this
      );
    }),
    (s.prototype.position = function () {
      var e = this,
        i = e.config;
      return (
        P.position(e.bindElem || e.elemColorBox[0], e.elemPicker[0], {
          position: i.position,
          align: "center",
        }),
        e
          ...
          "torgb" === o
            ...
            ? ((o = L(n)),
              3 === (n.match(/[0-9]{1,3}/g) || []).length
                ...
                : (t.find("input").val(n),
                  (n = 280 * n.slice(n.lastIndexOf(",") + 1, n.length - 1)),
                  i.elemPicker.find("." + Y).css("left", n)),
          ...
          var i = e.clientY - x(this).offset().top + W.scrollTop(),
            ...
            o =
              ((i = i < 0 ? 0 : i) > this.offsetHeight &&
                (i = this.offsetHeight),
              ((o =
                (o = o < 0 ? 0 : o) > this.offsetWidth ? this.offsetWidth : o) /
                260) *
                100),
            i = 100 - (i / 180) * 100;
          y(p, (g = o), (h = i), v),
              ...
              P.touchSwipe(t.elem, {
                ...
                onTouchMove: function (e) {
                  ...
                  (e = e),
                    (i = t.eventType),
                    (e = e.touches[0]),
                    (o = document.createEvent("MouseEvent")).initMouseEvent(
                      i,
                      !0,
                      !0,
                      window,
            ...
            -1 < l.indexOf(",")
              ? ((t = j(L(l))),
                ...
                3 < (l.match(/[0-9]{1,3}/g) || []).length &&
                  ...
                  ((n = 280 * l.slice(l.lastIndexOf(",") + 1, l.length - 1)),
                  c.elemPicker.find("." + Y).css("left", n),
                  (o = s[0].style.background = l)))
              : (3 ===
                  (n = -1 < (n = l).indexOf("#") ? n.substring(1) : n).length &&
                  (n = (r = n.split(""))[0] + r[0] + r[1] + r[1] + r[2] + r[2]),
                (r = {
                ...
                c.elemColorBox
                  ...
                  .addClass(C)),
              "change" === i
                ? (c.select(t.h, t.s, t.b, i), a.change && a.change(o))
...
layui.define("jquery", function (t) {
    ...
    h =
      ...
      (i.prototype.tabAdd = function (t, i) {
        ...
        return (
          ...
          w.tabAuto(i.change ? "change" : null, e),
          this
        );
      }),
      (i.prototype.tabDelete = function (t, i, a) {
        t = u(".layui-tab[lay-filter=" + t + "]")
          .children(c)
          .find('>li[lay-id="' + i + '"]');
        return w.tabDelete.call(t[0], { liElem: t, force: a }), this;
      }),
      (i.prototype.tabChange = function (t, i, a) {
        t = u(".layui-tab[lay-filter=" + t + "]")
          .children(c)
          .find('>li[lay-id="' + i + '"]');
        return w.tabClick.call(t[0], { liElem: t, force: a }), this;
      }),
      (i.prototype.tab = function (a) {
        (a = a || {}),
          e.on("click", a.headerElem, function (t) {
            var i = u(a.headerElem).index(u(this));
            w.tabClick.call(this, { index: i, options: a });
          });
      }),
    ...
    w = {
      tabClick: function (t) {
        ...
        if (!t.force) {
          ...
          if (
            !1 ===
            layui.event.call(this, r, "tabBeforeChange(" + s + ")", {
              elem: e,
              from: {
        ...
        l ||
          n ||
          (a.addClass(y).siblings().removeClass(y),
          (o
            ? (t = (t = i.filter('[lay-id="' + o + '"]')).length ? t : i.eq(c))
            : i.eq(c)
          )
            .addClass(f)
            .siblings()
            .removeClass(f)),
          layui.event.call(this, r, "tab(" + s + ")", {
            elem: e,
            index: c,
            id: o,
          });
      ...
      tabDelete: function (t) {
        ...
        if (
          !t.force &&
          !1 ===
            layui.event.call(i[0], r, "tabBeforeDelete(" + n + ")", {
              elem: e,
              index: a,
              id: s,
            })
        ...
        i.hasClass(y) &&
          (i.next()[0] && i.next().is("li")
            ? w.tabClick.call(i.next()[0], { index: a + 1 })
            : i.prev()[0] &&
              i.prev().is("li") &&
              w.tabClick.call(i.prev()[0], null, a - 1)),
          i.remove(),
          (s
            ? (t = (t = l.filter('[lay-id="' + s + '"]')).length ? t : l.eq(a))
            : l.eq(a)
          ).remove(),
          setTimeout(function () {
            w.tabAuto(null, e);
          }, 50),
          layui.event.call(this, r, "tabDelete(" + n + ")", {
            elem: e,
            index: a,
            id: s,
          });
          ...
          e &&
            ...
            a.find("li").each(function () {
              var t,
                i = u(this);
              i.find("." + o)[0] ||
                "false" === i.attr("lay-allowclose") ||
                ((t = u(
                  '<i class="layui-icon layui-icon-close layui-unselect ' +
                    o +
                    '"></i>'
                )).on("click", function (t) {
                  w.tabDelete.call(this, { e: t });
                }),
                i.append(t));
            }),
            "string" != typeof t.attr("lay-unauto") &&
              ...
              (a.find("li").length &&
                a.height() > (e = a.find("li").eq(0).height()) + e / 2)
      ...
      clickThis: function () {
        ...
        if (
          (("javascript:;" !== t.attr("href") &&
            ...
            n ||
            l[0] ||
            (i.find("." + y).removeClass(y), e.addClass(y)),
          i.hasClass(v))
        ) {
          var n = p + "ed",
            s = !e.hasClass(n),
      ...
      collapse: function () {
        ...
        "string" == typeof e.attr("lay-accordion") &&
          ((e = e.children(".layui-colla-item").children("." + f))
            .siblings(".layui-colla-title")
            .children(".layui-colla-icon")
            .html("&#xe602;"),
          e.removeClass(f)),
          a[n ? "addClass" : "removeClass"](f),
          i.html(n ? "&#xe61a;" : "&#xe602;"),
          layui.event.call(this, r, "collapse(" + l + ")", {
            title: t,
            content: a,
            show: n,
          });
                  ...
                  l[0] && l.remove(),
                        ...
                        i.hasClass(v)
                          ...
                          : (clearTimeout(o[t]),
                            (o[t] = setTimeout(function () {
                              i.find("." + m).removeClass(f),
                                i.find("." + g).removeClass(g + "d");
                            }, 300)));
                      }),
                    i
                      .off("mouseleave.lay_nav")
                    ...
                    e.find("a").each(function () {
                      ...
                      t.siblings("." + m)[0] &&
                        !t.children("." + g)[0] &&
                        t.append(
                          '<i class="layui-icon layui-icon-down ' + g + '"></i>'
                        ),
                        t.off("click", w.clickThis).on("click", w.clickThis);
                    });
                });
              },
                  ...
                  u(this)
                    ...
                    .each(function () {
                      ...
                      i.find(".layui-colla-icon").remove(),
                        ...
                        i.off("click", w.collapse).on("click", w.collapse);
                    });
                });
              },
            };
          return t && "object" == typeof i && i instanceof u
            ? e[t](i)
            : e[t]
            ? e[t]()
            : layui.each(e, function (t, i) {
                i();
              });
        }),
      new i()),
  ...
  u(function () {
    ...
    e.on("click", ".layui-tab-title li", w.tabClick),
    u(window).on("resize", w.tabAuto),
    t(r, a);
});
layui.define(["lay", "layer"], function (e) {
  ...
  var F = layui.$,
    ...
    D = function (e) {
      var t = this;
      (t.index = ++w.index),
        (t.config = F.extend({}, t.config, w.config, e)),
        t.render();
    };
  (D.prototype.config = {
    accept: "images",
        ...
        : (F.extend(
          ...
          !e && n[0] && n.data(s)
            ? (e = o.getThis(n.data(s)))
              ...
              : void 0
            : ((i.elem = F(i.elem)),
              (i.bindAction = F(i.bindAction)),
              (i.id = "id" in i ? i.id : n.attr("id") || t.index),
              t.file(),
              void t.events()));
    }),
    ...
    (D.prototype.upload = function (e, t) {
      var i,
                  ...
                  return (
                    e.upload.addEventListener("progress", function (e) {
                      ...
                      e.lengthComputable &&
                        ...
                        f.progress(t, (f.item || f.elem)[0], e, i.index));
                    }),
                    e
                  );
                }),
        ...
        h = function (e) {
          if ("json" === f.force && "object" != typeof e)
            try {
              return { status: "CONVERTED", data: JSON.parse(e) };
            } catch (t) {
              return (
                u.msg(s["data-format-error"]),
                { status: "FORMAT_ERROR", data: {} }
              );
            }
      ...
      if (0 !== y.length) {
        switch (f.accept) {
          ...
          case "video":
            layui.each(y, function (e, t) {
              if (
                !RegExp(
                  ".\\.(" + (v || "avi|mp4|wma|rmvb|rm|flash|3gp|flv") + ")$",
                  "i"
                ).test(escape(t))
              )
                return (i = !0);
          ...
          default:
            layui.each(y, function (e, t) {
              if (
                !RegExp(
                  ".\\.(" + (v || "jpg|png|gif|bmp|jpeg|svg|webp") + ")$",
                  "i"
                ).test(escape(t))
              )
                return (i = !0);
        ...
        if (
          ...
          if (
            ...
            return u.msg(
              "function" == typeof s["limit-number"]
          ...
          (r = function () {
            ...
            "function" == typeof f.before
              ? w.util.promiseLikeResolve(f.before(x)).then(
                  ...
                  function (e) {
                    f.auto && (l.value = ""),
                      e !== undefined && layui.hint().error(e);
                  }
                )
              : r();
        }
    ...
    (D.prototype.events = function () {
      var a = this,
        ...
        r = function (e, t) {
          ...
          i.next().hasClass(L) && i.next().remove(),
            a.upload(null, "choose"),
            a.isFile() ||
              n.choose ||
              i.after('<span class="layui-inline ' + L + '">' + e + "</span>");
        },
        l = function (i) {
          var n = !0;
          return (
        ...
        u = function (e) {
          var i = function (e) {
            (e.ext = e.name.substr(e.name.lastIndexOf(".") + 1).toLowerCase()),
              (e.sizes = w.util.parseSize(e.size));
          };
          return (
    ...
    (o.getThis = function (e) {
      ...
      return (
        t ||
          hint.error(
            e
              ? i + " instance with ID '" + e + "' not found"
              : "ID argument required"
          ),
        t
      );
...
layui.define(["lay", "layer", "util"], function (e) {
  ...
  var T = layui.$,
    ...
    t = function () {
      this.config = {
        verify: {
          required: function (e) {
            if (!/[\S]+/.test(e) || e === undefined || null === e)
              return "\u5fc5\u586b\u9879\u4e0d\u80fd\u4e3a\u7a7a";
          },
          phone: function (e) {
            if (e && !/^1\d{10}$/.test(e))
    ...
    i =
      ...
      (t.prototype.getFormElem = function (e) {
        return T(p + (e ? '[lay-filter="' + e + '"]' : ""));
      }),
      (t.prototype.on = function (e, t) {
        return layui.onevent.call(this, _, e, t);
      }),
      (t.prototype.val = function (e, o) {
        return (
            ...
            (t.name = (t.name || "").replace(/^\s*|\s*&/, "")),
              t.name &&
                (/^.*\[\]$/.test(t.name) &&
                  ((i = t.name.match(/^(.*)\[\]$/g)[0]),
                  (n[i] = 0 | n[i]),
                  (i = t.name.replace(/^(.*)\[\]$/, "$1[" + n[i]++ + "]"))),
                (/^(checkbox|radio)$/.test(t.type) && !t.checked) ||
                  (l[i || t.name] =
                    "SELECT" === this.tagName &&
                    "string" == typeof this.getAttribute("multiple")
                      ? a.val() || []
                      : this.value));
          }),
          l
            ...
            input: function (e) {
                  ...
                  function (e, t) {
                    ...
                    if ((e.toggleClass(y, u), !u)) {
                      if ("click" === t) {
                        if (
                          "text" === e[0].type &&
                          "string" == typeof e.attr("readonly")
                        )
                          return;
                        a = !!T(this).index() ? a - n : a + n;
                      }
                      (u = function (e) {
                        return ((e.toString().match(/\.(\d+$)/) || [])[1] || "")
                          .length;
                      }),
                        (o = 0 <= o ? o : Math.max(u(n), u(i)));
                      s ||
                        (c ||
                          (r <=
                            (a =
                              (a = d ? Math.round(a / n) * n : a) <= l
                                ? l
                                : a) &&
                            (a = r)),
                        0 === o
                          ...
                          : 0 < o && (a = a.toFixed(o)),
                        e.val(a),
                        e.attr("lay-input-mirror", e.val())),
                        e[(a < l || r < a) && !s ? "addClass" : "removeClass"](
                          "layui-input-number-out-of-range"
                        ),
                        c ||
                          ((t = {
                            ...
                            r <= a && !s ? "addClass" : "removeClass"
                          ](A),
                          t.decrement[
                            a <= l && !s ? "addClass" : "removeClass"
                          ](A));
                    }
                  });
              a.find("input[lay-affix],textarea[lay-affix]").each(function () {
                var r = T(this),
                  ...
                  d = function (e, t) {
                    (e = T(e))[0] &&
                      e[T.trim(t) ? "removeClass" : "addClass"](O);
                  },
                  n = function (i) {
                    i = T.extend(
                      {},
                    ...
                    l[0]
                      ...
                      e.on("click", function () {
                        ...
                        T(this).hasClass(A) ||
                          ...
                          layui.event.call(this, _, "input-affix(" + e + ")", {
                            elem: r[0],
                            affix: o,
                            options: i,
                          }));
                  ...
                  p = {
                    ...
                    number: {
                      ...
                      init: function (a) {
                        var e, n, l, t, i, r;
                        ("text" !== a.attr("type") && "text" !== a[0].type) ||
                          ((l = n = !(e = ".lay_input_number")),
                          (t = "string" == typeof a.attr("readonly")),
                          (i = "string" == typeof a.attr("lay-wheel")),
                          (r = a.next(".layui-input-number").children("i")),
                          a.attr("lay-input-mirror", a.val()),
                          a.off(e),
                          a.on("keydown" + e, function (e) {
                            (n = !1),
                              (8 !== e.keyCode && 46 !== e.keyCode) || (n = !0),
                              t ||
                                2 !== r.length ||
                                (38 !== e.keyCode && 40 !== e.keyCode) ||
                                (e.preventDefault(),
                                r.eq(38 === e.keyCode ? 0 : 1).click());
                          }),
                          a.on(
                            "input" + e + " propertychange" + e,
                            function (e) {
                              var t, i;
                              l ||
                                ("propertychange" === e.type &&
                                  "value" !== e.originalEvent.propertyName) ||
                                (n ||
                                "" === (e = this.value) ||
                                ("00" !== e.slice(0, 2) &&
                                  !e.match(/\s/g) &&
                                  !(
                                    ((t = e.match(/\./g)) && 1 < t.length) ||
                                    ((t = e.match(/e/g)) && 1 < t.length) ||
                                    ((i = e.slice(1)),
                                    (t = i.match(/(\+|-)/g)) &&
                                      (!/e(\+|-)/i.test(i) || 1 < t.length)) ||
                                    (isNaN(Number(e)) &&
                                      -1 === m.indexOf(e.slice(-1))) ||
                                    (/e/i.test(e) &&
                                      (!/\de/i.test(e) || /e\./.test(e)))
                                  ))
                                  ? a.attr("lay-input-mirror", this.value)
                                  : (this.value = a.attr("lay-input-mirror")),
                                a.toggleClass(y, isNaN(Number(this.value))));
                            }
                          ),
                          ...
                          i &&
                            a.on(
                              ["wheel", "mousewheel", "DOMMouseScroll"].join(
                                e + " "
                              ) + e,
                              function (e) {
                                var t;
                  ...
                  t ||
                    ((d =
                      "cs" === f.attr("lay-search")
                        ? { caseSensitive: !0 }
                        : lay.options(f, { attr: "lay-search" })),
                    (r = f.attr("lay-append-to") || "body"),
                    (o = f.attr("lay-append-position")),
                    (s = !(
                      !lay.ie ||
                      ("10" !== lay.ie && "11" !== lay.ie) ||
                      !m.attr("placeholder")
                    ...
                    (c = function () {
                      a &&
                        (l.appendTo(r).css({ width: v.width() + "px" }),
                        (e = function () {
                          lay.position(v[0], l[0], {
                            position: o,
                            allowBottomOut: !0,
                            offset: [0, 5],
                          });
                      ...
                      var e =
                          l.offset().top + l.outerHeight() + 5 - S.scrollTop(),
                        t = g.outerHeight(),
                        i = g.children("dd");
                      (x = f[0].selectedIndex),
                        ...
                        b.removeClass(O),
                        i.removeClass(E),
                        0 <= x && i.eq(x).addClass(E),
                        e + t > S.height() && t <= e && l.addClass(C + "up"),
                        h(),
                        s &&
                          g
                            .off("mousedown.lay_select_ieph")
                            .on("mousedown.lay_select_ieph", function () {
                              (m[0].__ieph = !0),
                                setTimeout(function () {
                                  m[0].__ieph = !1;
                                }, 60);
                            }),
                        (n = lay.onClickOutside(
                          (a ? l : g)[0],
                          function () {
                            p(), k && m.val(k);
                          },
                          { ignore: v, detectIframe: !0, capture: !1 }
                        ));
                    }),
                    (p = function (e) {
                      v.parent().removeClass(C + "ed " + C + "up"),
                        m.blur(),
                        u && g.children("." + N).remove(),
                        "function" == typeof n && (n(), (n = null)),
                        a &&
                          (l.detach(),
                          T(window).off("resize.lay_select_resize")),
                        e ||
                          y(m.val(), function (e) {
                            var t = f[0].selectedIndex;
                            e &&
                              ((k = T(f[0].options[t]).prop("text")),
                              0 === t &&
                    ...
                    (h = function () {
                      ...
                      i[0] &&
                        ...
                        (t = g.height()),
                        (i = i.height()),
                        t < e && g.scrollTop(e + g.scrollTop() - t + i - 5),
                        e < 0) &&
                        g.scrollTop(e + g.scrollTop() - 5);
                    }),
                    v.on("click", function (e) {
                      (v.parent().hasClass(C + "ed") ? p : c)(),
                        g.find("." + w).remove();
                    }),
                        ...
                        var e = n.keyCode,
                          t =
                            ...
                            function (e) {
                              ...
                              var t,
                                i,
                                a = g.children("dd:not(." + O + ",." + A + ")");
                              a.length &&
                                ((t = a.length - 1),
                                (i = -1),
                                layui.each(a, function (e, t) {
                                  if (T(t).hasClass(E)) return (i = e), !0;
                                }),
                                (e =
                                  "prev" === e
                                    ? i - 1 < 0
                                    ...
                                    ? 0
                                    : i + 1),
                                a.eq(e).addClass(E).siblings().removeClass(E),
                                h());
                            });
                        38 === e && t("prev"),
                          40 === e && t("next"),
                    ...
                    (y = function (n, e, l) {
                      var r,
                        ...
                        c = n,
                        t =
                          (d.caseSensitive || (n = n.toLowerCase()),
                          d.fuzzy &&
                            (r = (function (e, t) {
                              var i = {},
                                a = ["^"];
                              ...
                              return (
                                a.push(".*"),
                                new RegExp(a.join(""), t ? undefined : "i")
                              );
                            })(n, d.caseSensitive)),
                          layui.each(t, function () {
                            var e = T(this),
                              ...
                              a =
                                (u && !i && t === c && (s = !0),
                                d.caseSensitive || (t = t.toLowerCase()),
                                d.fuzzy ? !r.test(t) : -1 === t.indexOf(n));
                            ("" === n || "blur" === l ? n !== t : a) && o++,
                              "keyup" === l &&
                                e[
                                  (u ? a && !i : a) ? "addClass" : "removeClass"
                                ](O);
                          }),
                          "keyup" === l &&
                            layui.each(b, function () {
                            ...
                            return (
                              ...
                              (s && e.target.__ieph
                                ...
                                : (y(
                                  ...
                                  "" === n &&
                                    (f.val(""),
                                    g.find("." + E).removeClass(E),
                                    (f[0].options[0] || {}).value ||
                                      g.children("dd:eq(0)").addClass(E),
                                    g.find("." + w).remove(),
                                    u) &&
                                    g.children("." + N).remove(),
                                  void h()))
                    ...
                    g.on("click", "dd", function () {
                      ...
                      return (
                        i.hasClass(A) ||
                          (u &&
                            i.hasClass(N) &&
                            ((t = (e = T("<option>").text(i.text())).prop(
                              "text"
                            )),
                            e.attr("value", (a = t)),
                            f.append(e),
                            i.removeClass(N).attr("lay-value", t).text(t),
                            g.append(i)),
                          i.hasClass("layui-select-tips")
                            ? m.val("")
                            : (m.val(i.text()), i.addClass(E)),
                          i.siblings().removeClass(E),
                          f.val(a).removeClass("layui-form-danger"),
                          layui.event.call(this, _, "select(" + n + ")", {
                            elem: f[0],
                            value: a,
                            othis: l,
                          }),
                    ...
                    l.find("dl>dt").on("click", function (e) {
                      return !1;
                    }),
                    a &&
              ...
              (T.event.special["_lay-select-destroy"] = {
                ...
                e.each(function (e, t) {
                  var i = T(this),
                    ...
                    n = this.disabled,
                    l = t.value,
                    r = T(t.options[t.selectedIndex]),
                    t = t.options[0];
                  if (i.closest("[lay-ignore]").length) return i.show();
                  var o,
                    s,
                    c = "string" == typeof i.attr("lay-search"),
                    u = "string" == typeof i.attr("lay-creatable") && c,
                    d = "string" == typeof i.attr("lay-append-to"),
                    t = (t && !t.value && t.text) || h,
                    t =
                      ((s = T('<div class="' + C + '"></div>')),
                      c || s.addClass("layui-unselect"),
                      n && s.addClass("layui-select-disabled"),
                      (p = T('<input type="text" class="layui-input">')).prop(
                        "placeholder",
                        t
                      ),
                      p.val(l ? r.prop("text") : ""),
                      (c && !n) || p.prop("readonly", !0),
                      n && p.addClass(A),
                      p),
                    p =
                      ((r = T('<div class="layui-select-title"></div>')).append(
                        t
                      ),
                      r.append('<i class="layui-edge"></i>'),
                      r),
                    r =
                      ((t = T('<dl class="layui-anim layui-anim-upbit"></dl>')),
                      i.find("optgroup")[0] && t.addClass("layui-select-group"),
                      (o = []),
                      layui.each(i.find("optgroup,option"), function (e, t) {
                        var i = t.tagName.toLowerCase(),
                          a = T('<dd lay-value=""></dd>');
                        0 !== e || t.value || "optgroup" === i
                          ? "optgroup" === i
                            ? ((e = T("<dt></dt>")).text(t.label),
                              o.push(e.prop("outerHTML")))
                            : (a.attr("lay-value", t.value),
                              l === t.value && a.addClass(E),
                              t.disabled && a.addClass(A),
                              a.text(t.text),
                              o.push(a.prop("outerHTML")))
                          : (a.addClass("layui-select-tips"),
                            a.text(t.text || h),
                            o.push(a.prop("outerHTML")));
                      }),
                      0 === o.length &&
                        o.push('<dd lay-value="" class="' + A + '">None</dd>'),
                      (r = o.join("")),
                      t.html(r),
                      t);
                  a[0] && (d && (t = a.data(y)) && t.remove(), a.remove()),
                    d
                      ? (s.append(p),
                        i.after(s),
                        (t = T(
                          '<div class="' +
                            C +
                            ' layui-select-panel-wrap"></div>'
                        ).append(r)),
                        s.data(y, t),
                        f.call(this, t, p, n, c, u, d))
                      : (s.append(p).append(r),
                        i.after(s),
                        f.call(this, s, p, n, c, u, d));
                });
            },
            checkbox: function (e) {
              var c = {
              ...
              e.each(function (e, t) {
                var i = T(this),
                  ...
                  n = d.escape(
                    T.trim(t.title || (t.title = i.attr("lay-text") || ""))
                  ),
                  l = this.disabled,
                  r = c[a] || c.checkbox,
                  o = i.next("." + r[0]),
                ...
                if (
                  (i.next("[lay-checkbox]")[0] &&
                    ((o = i.next()),
                    (n = o.html() || ""),
                    1 < o[0].attributes.length) &&
                    layui.each(o[0].attributes, function (e, t) {
                      "lay-checkbox" !== t.name &&
                        s.push(t.name + '="' + t.value + '"');
                    }),
                  (s = s.join(" ")),
                  (n = "switch" === a ? n.split("|") : [n]),
                  i.closest("[lay-ignore]").length)
                )
                  return i.show();
                f &&
                  (v.call(t, "lay-form-sync-checked", t.checked),
                  t.checked ||
                    v.call(t, "lay-form-sync-indeterminate", t.indeterminate));
                l = T(
                  [
                    '<div class="layui-unselect ' + r[0],
                    t.checked ? " " + r[1] : "",
                    l ? " layui-checkbox-disabled " + A : "",
                    '"',
                    a ? ' lay-skin="' + a + '"' : "",
                    ">",
                    (o = {
                  ...
                  function (t, i) {
                    ...
                    t.on("click", function () {
                      ...
                      a[0].disabled ||
                        ...
                        layui.event.call(a[0], _, i[2] + "(" + e + ")", {
                          elem: a[0],
                          value: a[0].value,
                          othis: t,
                        }));
                    }),
                      u.syncAppearanceOnPropChanged(
                        this,
                        "checked",
                        function () {
                          var e;
                          n &&
                            ((e = (
                              t.next("*[lay-checkbox]")[0]
                                ? t.next().html()
                                : a.attr("title") || ""
                            ).split("|")),
                            t
                              .children("div")
                              .html((!this.checked && e[1]) || e[0])),
            ...
            radio: function (e) {
              ...
              e.each(function (e, t) {
                var i = T(this),
                  ...
                  l = i.attr("lay-skin");
                if (i.closest("[lay-ignore]").length) return i.show();
                f && v.call(t, "lay-form-sync-checked", t.checked),
                  a[0] && a.remove();
                var a = d.escape(t.title || ""),
                  r = [],
                  o =
                    (i.next("[lay-radio]")[0] &&
                      ((a = (o = i.next()).html() || ""),
                    ...
                    T(
                      [
                        '<div class="layui-unselect ' + s,
                        t.checked ? " " + s + "ed" : "",
                        (n ? " layui-radio-disabled " + A : "") + '"',
                        l ? ' lay-skin="' + l + '"' : "",
                        ">",
                ...
                i.after(o),
                  function (i) {
                    ...
                    i.on("click", function () {
                      ...
                      a[0].disabled ||
                        ((a[0].checked = !0),
                        layui.event.call(a[0], _, "radio(" + e + ")", {
                          elem: a[0],
                          value: a[0].value,
                          othis: i,
                        }));
      ...
      (t.prototype.syncAppearanceOnPropChanged = f
        ? function (e, t, i) {
            ...
            Object.defineProperty(
              ...
              lay.extend({}, a, {
                get: function () {
                  return (
                    "string" == typeof this.getAttribute("lay-form-sync-" + t)
                  );
                },
                set: function (e) {
                  v.call(this, "lay-form-sync-" + t, e), i.call(this);
                },
              })
            );
          }
          ...
          ((e.attr("lay-verify") !== undefined ||
            ...
            (layui.each(e, function (e, r) {
              var o = T(this),
                ...
                c = "string" == typeof (c = o.val()) ? T.trim(c) : c;
              if (
                (o.removeClass(p),
      ...
      (t.prototype.submit = function (e, t) {
        var i = {},
          ...
          n = this.getFormElem ? this.getFormElem(e) : a.parents(p).eq(0),
          l = n.find("*[lay-verify]");
        return (
          !!r.validate(l) &&
          ((i = r.getValue(null, n)),
          ...
          layui.event.call(this, _, "submit(" + e + ")", l))
        );
      }));
  function v(e, t) {
    var i = !!t,
    ...
    return null !== this.getAttribute(e)
      ? i || (this.removeAttribute(e), !1)
      : !t && (this.setAttribute(e, ""), !0);
  }
  var m = ["-", ".", "e", "E", "+"];
  var r = new t(),
    t = T(document),
  ...
  T(function () {
    ...
    t.on("submit", p, i).on("click", "*[lay-submit]", i),
    e(_, r);
});
layui.define(["lay", "laytpl", "laypage", "form", "util"], function (s) {
  ...
  var f = layui.$,
          ...
          (i =
            "function" == typeof t
              ...
              : m(
                ...
                ).render(f.extend({ LAY_COL: a }, e.tplData))),
    ...
    c =
      ...
      (n.prototype.render = function (e) {
        ...
        (a.index = t.index),
          ...
          a.height && /^full-.+$/.test(a.height)
            ? ((t.fullHeightGap = a.height.split("-")[1]),
              (a.height = d.height() - (parseFloat(t.fullHeightGap) || 0)))
            : a.height && /^#\w+\S*-.+$/.test(a.height)
            ? ((i = a.height.split("-")),
              (t.parentHeightGap = i.pop()),
              (t.parentDiv = i.join("-")),
              (a.height =
                f(t.parentDiv).height() - (parseFloat(t.parentHeightGap) || 0)))
            : "function" == typeof a.height &&
              ((t.customHeightFunc = a.height),
        ...
        n
          .addClass(
            ((l = [_, _ + "-" + t.index, "layui-form", "layui-border-box"]),
          ...
          .html(
            m(B, { open: "{{", close: "}}", tagStyle: "legacy" }).render({
              data: a,
              index: t.index,
            })
          ),
      ...
      (n.prototype.renderStyle = function () {
        ...
        layui.each(l.cols, function (a, e) {
          ...
          (e = l.lineStyle) &&
            ((a =
              ".layui-table-view-" + n + " .layui-table-body .layui-table tr"),
            (t = e.split(";")),
            (i = "none"),
            layui.each(t, function (e, t) {
      ...
      (n.prototype.renderToolbar = function () {
                    ...
                    list:
                      ...
                      i.on("checkbox(LAY_TABLE_TOOL_COLS)", function (e) {
                        ...
                        i.key &&
                          ...
                          o.elem
                            .find('*[data-key="' + a + '"]')
                            [t ? "removeClass" : "addClass"](W),
                          l != i.hide && o.setParentCol(!t, e),
                          o.resize(),
                          layui.event.call(this, R, "colToggled(" + d + ")", {
                            col: i,
                            config: n,
                          }));
                      });
                ...
                onClick: function (e) {
                  ...
                  a.append(o.layMain.find("table").html()),
                    ...
                    a
                      ...
                      .remove(),
                    a.find("tbody>tr>td." + F).remove(),
                    t.document.write(e + a.prop("outerHTML")),
                    t.document.close(),
                    layui.device("edg").edg
                      ? ((t.onafterprint = t.close), t.print())
                      : (t.print(), t.close());
                },
              },
            });
        "object" == typeof e.defaultToolbar &&
          ((l = []),
          (e.defaultToolbar = f.map(e.defaultToolbar, function (e, t) {
            var a = "string" == typeof e,
              i = a ? n[e] : e;
            return (
              i &&
                (!(i = i.name && n[i.name] ? f.extend({}, n[i.name], i) : i)
                  .name &&
                  a &&
                  (i.name = e),
                l.push(
      ...
      (n.prototype.setGroupWidth = function (i) {
        ...
        l.config.cols.length <= 1 ||
          ((e = l.layHeader.find(
            (i ? "th[data-key=" + i.data("parentkey") + "]>" : "") + "." + u
          )).css("width", 0),
      ...
      (n.prototype.setColsWidth = function (e) {
        var n,
          ...
          e =
            ...
            (u =
              u -
              ("line" === d.skin || "nob" === d.skin ? 2 : a + 1) * i -
              o.getScrollWidth(o.layMain[0])),
            function (o) {
        ...
        o.eachCols(function (e, a) {
          ...
          n &&
            o.cssRules(n.key, function (e) {
              ...
              (e.style.width = a + "px"),
                !p && h && y.width(o.getContentWidth(l)),
                o.layMain.prop("offsetHeight") >
                  o.layMain.prop("clientHeight") &&
                  (e.style.width = parseFloat(e.style.width) - i + "px");
            }),
          !p && h ? y.width(o.getContentWidth(l)) : y.width("auto"),
          o.setGroupWidth();
      }),
      (n.prototype.resize = function () {
        var e = this;
        e.layMain &&
          ("isConnected" in e.layMain[0]
            ? e.layMain[0].isConnected
            : f.contains(document.body, e.layMain[0])) &&
      ...
      (n.prototype.page = 1),
      (n.prototype.pullData = function (i, l) {
        var e,
          t,
          n = this,
          o = n.config,
          a =
            (o.HAS_SET_COLS_PATCH || n.setColsPatch(),
            (o.HAS_SET_COLS_PATCH = !0),
            o.request),
          d = o.response,
          r = function () {
            "object" == typeof o.initSort &&
              n.sort({
          ...
          c = function (e, t) {
            n.setColsWidth(),
              n.loading(!1),
              "function" == typeof o.done && o.done(e, i, e[d.countName], t);
          };
        (l = l || {}),
          "function" == typeof o.before && o.before(o),
          (n.startTime = new Date().getTime()),
          l.renderData
            ? (((e = {})[d.dataName] = k.cache[n.key]),
              (e[d.countName] = o.url
                ? "object" === layui.type(o.page)
                  ? o.page.count
                  : e[d.dataName].length
                : o.data.length),
              "object" == typeof o.totalRow &&
            ...
            : o.url
            ? ((t = {}),
              o.page && ((t[a.pageName] = i), (t[a.limitName] = o.limit)),
              (a = f.extend(t, o.where)),
              o.contentType &&
                0 == o.contentType.indexOf("application/json") &&
                (a = JSON.stringify(a)),
              n.loading(!0),
              n._xhr &&
                4 !== n._xhr.readyState &&
                ((n._xhrAbort = !0), n._xhr.abort()),
              (n._xhr = f.ajax({
                type: o.method || "get",
                url: o.url,
                ...
                headers: o.headers || {},
                complete:
                  "function" == typeof o.complete ? o.complete : undefined,
                success: function (e) {
                  var t, a;
                  (e =
                    "function" == typeof o.parseData ? o.parseData(e) || e : e)[
                    d.statusName
                  ] != d.statusCode
                    ? n.errorView(
                        e[d.msgName] ||
                    ...
                    : ((t = e[d.countName]),
                      (a = Math.ceil(t / o.limit) || 1) < i && (i = a),
                      (n.totalRow = e[d.totalRowName]),
                      n.renderData({ res: e, curr: i, count: t, type: l.type }),
                      r(),
                      (o.time = new Date().getTime() - n.startTime + " ms")),
                    c(e, l.type);
                },
                error: function (e, t) {
                  e && 0 === e.status && n._xhrAbort
                    ? (n._xhrAbort = !1)
                    : (n.errorView(
                        "\u8bf7\u6c42\u5f02\u5e38\uff0c\u9519\u8bef\u63d0\u793a\uff1a" +
                          t
            ...
            : "array" === layui.type(o.data) &&
              ((e = {}),
              (t = i * o.limit - o.limit),
              (a = o.data.concat()),
              (e[d.dataName] = o.page ? a.splice(t, o.limit) : a),
              (e[d.countName] = o.data.length),
              "object" == typeof o.totalRow &&
                (e[d.totalRowName] = f.extend({}, o.totalRow)),
              (n.totalRow = e[d.totalRowName]),
              n.renderData({
                res: e,
                curr: i,
        ...
        return (
          ...
          layui.each(a, function (e, o) {
            ...
            ("array" === layui.type(o) && 0 === o.length) ||
              ...
              (o[k.config.indexName] = e),
              l || (o[k.config.initIndexName] = e),
                    ...
                    ((e = [
                      '<td data-field="' +
                        ...
                        (t =
                          ...
                          e.push('data-edit="' + t + '"'),
                        l.templet &&
                          e.push('data-content="' + v.escape(n) + '"'),
      ...
      (n.prototype.renderData = function (e) {
        ...
        return (
          ...
          a.layPage[i.page || i.pagebar ? "removeClass" : "addClass"](W),
          a.layPage
            .find(P)
            [
          ...
          0 === d.length
            ...
            : (a.layFixLeft.removeClass(W),
              o
                ? u()
                : (u(),
                  a.renderTotal(d, t),
                  a.layTotal && a.layTotal.removeClass(W),
                  void (
                    i.page &&
                    ((i.page = f.extend(
                      {
          ...
          r.eachCols(function (e, t) {
            var e = t.field || e,
              ...
              i =
                ...
                (l =
                  (t.totalRow &&
                    T.call(r, { item3: t, content: i, tplData: l })) ||
                  n),
                a || l),
              l =
                "string" == typeof (n = t.totalRow || c.totalRow)
                  ? m(n).render(
                      f.extend(
                        {
                          TOTAL_NUMS: a || s[e],
              ...
              n =
                ...
                [
                  '<td data-field="' +
                    ...
                    '" ' +
                    ((n = []),
                    t.minWidth && n.push('data-minwidth="' + t.minWidth + '"'),
                    t.maxWidth && n.push('data-maxwidth="' + t.maxWidth + '"'),
                  ...
                  '<div class="layui-table-cell laytable-cell-' +
                    ((i = t.key),
                    "normal" === t.type ? i : i + " laytable-cell-" + t.type) +
                    '"' +
                    ((e = []),
      ...
      (n.prototype.setRowChecked = function (i) {
        var a,
          ...
          y = s || u;
        (c.tree && c.tree.view) ||
          (y && (r.layBox.addClass(O), "radio" === i.type)) ||
          (u &&
            ((a = {}),
            ...
            (i.index = a)),
          (e = r.layBody.children(".layui-table").children("tbody")),
          (d = y ? "tr" : 'tr[data-index="' + i.index + '"]'),
          (d = e.children(d)),
          (e = s
            ? d
            : d.filter(
          ...
          e.each(function () {
            ...
            t &&
              "array" !== layui.type(a) &&
              !a[c.disabledName] &&
              ((a = a[c.checkName] = n(e.hasClass(A))),
              e.toggleClass(A, !!a),
              "radio" === i.type) &&
              ((o = t), e.siblings().removeClass(A));
          }),
          o &&
          ...
          ("radio" === i.type && d.hasClass(W) ? s.first() : s).prop(
            "checked",
            n(u.prop("checked"))
          ),
          r.syncCheckAll(),
      ...
      (n.prototype.sort = function (l) {
        ...
        try {
          ...
          if (
            ...
            return;
          var c = t.layHeader.find("th .laytable-cell-" + r).find(L);
          t.layHeader.find("th").find(L).removeAttr("lay-sort"),
        ...
        (t.sortKey = { field: d, sort: l.type }),
          i.autoSort &&
            ("asc" === l.type
              ? (e = layui.sort(o, d, null, !0))
              : "desc" === l.type
              ? (e = layui.sort(o, d, !0, !0))
              : ((e = layui.sort(o, k.config.initIndexName, null, !0)),
                delete t.sortKey,
                delete i.initSort)),
      ...
      (n.prototype.loading = function (e) {
        this.config.loading &&
          this.layBox.find(".layui-table-init").toggleClass(W, !e);
      }),
      ...
      (n.prototype.fullSize = function () {
        ...
        i.fullHeightGap
          ...
          ? (l = f(i.parentDiv).height() - i.parentHeightGap) < 135 && (l = 135)
          ...
          (a = t.index),
            ...
            r.eachCols(function (e, t) {
              var a,
                i = String(t.field || e);
              (i in l ||
                (("function" == typeof n ? n(i, e) : n) &&
                  (t.templet || t.toolbar))) &&
                ((i = (e = d.children('td[data-field="' + i + '"]')).children(
                  c
                )),
                (a = o[t.field]),
                i.html(
      ...
      (n.prototype.events = function () {
        var c = this,
          ...
          y =
            (c.layTool.on("click", "*[lay-event]", function (e) {
                ...
                n = function (e) {
                  ...
                  a.html(t),
                    s.height &&
                      a.css(
                        "max-height",
                        s.height - (c.layTool.outerHeight() || 50)
                      ),
              ...
              layui.stope(e),
                z.trigger("table.tool.panel.remove"),
                g.close(c.tipsIndex),
            ...
            c.layHeader.on("click", "*[lay-event]", function (e) {
              ...
              layui.event.call(
                ...
                R,
                "colTool(" + o + ")",
                f.extend({ event: a, config: s, col: t }, {})
              );
            }),
            ...
            e
              .on("mousemove", function (e) {
                ...
                t.data("unresize") ||
                  w.eventMoveElem ||
                  ((r.allowResize = t.width() - e <= 10),
                  d.css("cursor", r.allowResize ? "col-resize" : ""));
              })
              .on("mouseleave", function () {
                f(this);
                ...
                r.allowResize &&
                  ...
                  c.cssRules(t, function (e) {
                    ...
                    (r.rule = e),
                      ...
                      (r.minWidth = a.data("minwidth") || s.cellMinWidth),
                      (r.maxWidth = a.data("maxwidth") || s.cellMaxWidth);
                  }),
                  a.data(j, r),
                  (w.eventMoveElem = a));
              }),
            w.docEvent ||
              z
                ...
                .on("mouseup", function (e) {
                  var t, a, i, l, n;
                  w.eventMoveElem &&
                    ((i = (t = w.eventMoveElem).closest("." + _).attr(N)),
                    (a = C(i))) &&
                    ((i = t.data("key")),
                    (l = a.col(i)),
                    ...
                    a.cssRules(i, function (e) {
                      (l.width = parseFloat(e.style.width)),
                        layui.event.call(t[0], R, "colResized(" + n + ")", {
                          col: l,
                          config: a.config,
                        });
                    }));
            ...
            e
              ...
              .on("click", function (e) {
                ...
                layui.stope(e),
                  0 === a
                    ? c.sort({ field: t, type: "asc", fromEvent: !0 })
                    : c.sort({ field: t, type: "desc", fromEvent: !0 });
              }),
              ...
              var a = f(this).parents("tr").eq(0).data("index"),
                ...
                l = {
                  ...
                  setRowChecked: function (e) {
                    c.setRowChecked(f.extend({ index: a }, e));
                  },
                };
              return f.extend(l, e);
            })),
            ...
            (c.elem.on(
              ...
              function (e) {
                var t = f(this),
                  ...
                  t = t.prev(),
                  i =
                    (c.layBody.find('input[name="layTableCheckbox"]'),
                    t.parents("tr").eq(0).data("index")),
                  l = t[0].checked,
                  n = "layTableAllChoose" === t.attr("lay-filter");
                t[0].disabled ||
                  (n
                    ? c.setRowChecked({ index: "all", checked: l })
                    : c.setRowChecked({ index: i, checked: l }),
                  layui.stope(e),
                  layui.event.call(
                    t[0],
                    R,
            ...
            c.layBody
              ...
              .on("mouseleave", "tr", function () {
                var e = f(this),
                  t = e.index();
                e.data("off") ||
                  c.layBody.find("tr:eq(" + t + ")").removeClass(M);
              })
          ...
          n = function (e, t) {
            ...
            (e = f(e)).data("off") ||
              ...
              (a = k.cache[c.key][a]),
              e.children(u),
              (i = "function" == typeof i.edit ? i.edit(a) : i.edit) &&
                (((i = f(
                  "textarea" === i
                    ? '<textarea class="layui-input ' +
                        E +
                        '" lay-unrow></textarea>'
                    : '<input class="layui-input ' + E + '" lay-unrow>'
                ))[0].value =
                  (l = e.data("content") || a[l]) === undefined || null === l
                    ? ""
                    : l),
                e.find("." + E)[0] || e.append(i),
                i.focus(),
                t) &&
                layui.stope(t));
          },
          i =
            (c.layBody
              .on("change", "." + E, function () {
                ...
                (e[i] = a),
                  l.update(e),
                  layui.event.call(t[0], R, "edit(" + o + ")", l);
              })
              .on("blur", "." + E, function () {
                f(this).remove();
              }),
          ...
          a = function (e) {
            ...
            t.data("off") ||
              ...
              (e
                ...
                : !(
                    a.prop("scrollWidth") > a.prop("clientWidth") ||
                    0 < a.find("br").length
                  ) ||
                  s.lineStyle ||
                  a.find("." + i)[0] ||
        ...
        c.layFixed.find(D).on("mousewheel DOMMouseScroll", function (e) {
          var t = e.originalEvent.wheelDelta || -e.originalEvent.detail,
      ...
      (n.prototype.getContentWidth = function (e) {
        ...
        return !(
          9 === e[0].nodeType ||
          (r.ie && "border-box" === e.css("box-sizing")) ||
          "none" === e.css("display")
        ) &&
          void 0 !== (t = this.getElementSize(e[0])) &&
          t.width
  ...
  (k.eachCols = function (e, a, i) {
    ...
    (k.checkStatus = function (e) {
      ...
      return (
        layui.each(e, function (e, t) {
          "array" === layui.type(t) || t[k.config.disabledName]
            ? a++
            : t[k.config.checkName] && (i.push(k.clearCacheKey(t)), l.push(t));
        }),
        {
          data: i,
          dataCache: l,
    ...
    (k.exportFile = function (e, t, a) {
      ...
      var i =
          (a = "object" == typeof a ? a : ((i = {}), a && (i.type = a), i))
            .type || "csv",
        o = w.that[e],
        l = w.config[e] || {},
      ...
      (d.href =
          ...
          layui.each(t, function (i, l) {
            ...
            "object" == typeof e
              ? (layui.each(e, function (e, t) {
                ...
                layui.each(
                  layui.isArray(l) ? f.extend([], l) : k.clearCacheKey(l),
                  function (e, t) {
                    n.push('"' + (t || "") + '"');
                  }
                ))
                  ...
                  !1 === t.ignoreExport || (t.field && "normal" == t.type)
                    ? (t.hide && !1 !== t.ignoreExport) || !0 === t.ignoreExport
                      ...
                      : (((a = l[t.field]) !== undefined && null !== a) ||
                          (a = ""),
                        0 == i &&
                          r.push(t.fieldTitle || t.title || t.field || ""),
                        (a = (a = T.call(o, {
                          item3: t,
                          content: a,
                          tplData: l,
        ...
        (d.download =
          (a.title || l.title || "table_" + (l.index || "")) + "." + i),
    ...
    (k.clearCacheKey = function (e) {
      return (
        ...
        delete e[k.config.initIndexName],
...
layui.define(["table"], function (e) {
  ...
  var A = layui.$,
    ...
    a = function (e) {
      var t = this;
      (t.index = ++B.index),
        (t.config = A.extend(!0, {}, t.config, B.config, e)),
        t.init(),
        t.render();
    },
    x = function (n, i, e) {
      ...
      layui.each(e || l, function (e, t) {
        var a = t[z] || "";
        -1 !== a.indexOf("-") && (l[a] = t), t[i] && x(n, i, t[i]);
      });
    },
    d = function (d, a, e) {
      var r = j(d),
        o =
          ("reloadData" !== e && (r.status = { expand: {} }),
      ...
      "reloadData" === e &&
        "fixed" === o.scrollPos &&
        (r.scrollTopCache = r.config.elem.next().find(s).scrollTop()),
        o.url
          ? (e && (!l || l.mod)) ||
            ((a.parseData = function () {
              var e = this,
                ...
                a = t[0],
                t =
                  ("function" === layui.type(l) && (a = l.apply(e, t) || t[0]),
                  e.response.dataName);
              return (
                n.data.isSimpleData &&
                  !n["async"].enable &&
                  (a[t] = r.flatToTree(a[t])),
                N(
                  a[t],
                  function (e) {
                    e[H] =
                      H in e
                        ? e[H]
                        : e[i] !== undefined && r.status.expand[e[i]];
                  },
                  c
                ),
                e.autoSort &&
          ...
          : a.data !== undefined &&
            ((a.data = a.data || []),
            n.data.isSimpleData && (a.data = r.flatToTree(a.data)),
            r.initData(a.data)),
        (e && (!u || u.mod)) ||
          ((a.done = function () {
            var e,
              ...
              l =
                (r.updateStatus(null, { LAY_HAS_EXPANDED: !1 }),
                x(d, c),
                i.find(
            ...
            if (
              ...
              r.renderTreeTable(i),
              "reloadData" === a &&
                "fixed" === this.scrollPos &&
                i.find(s).scrollTop(r.scrollTopCache),
        ...
        a &&
          ...
          layui.each(p, function (e, t) {
            a.tree.view[t] !== undefined &&
              (a.tree.view[t] = r.normalizedIcon(a.tree.view[t]));
          });
    };
  (a.prototype.init = function () {
    var e = this.config,
      ...
      t =
        ...
        P.render(A.extend({}, e, { data: [], url: "", done: null }))),
      a = t.config.id;
    ...
    (a.prototype.getOptions = function () {
      return this.tableIns
        ? P.getOptions(this.tableIns.config.id)
        : this.config;
    }),
    ...
    (a.prototype.treeToFlat = function (e, n, i) {
      ...
      return (
        layui.each(e, function (e, t) {
          var e = (i ? i + "-" : "") + e,
            a = A.extend({}, t);
          (a[o] = "undefined" != typeof t[o] ? t[o] : n),
            c.push(a),
  ...
  var r,
    ...
    J = function (t, a, n, i, l) {
      ...
      var m = y[X],
        ...
        v =
          (c.updateNodeIcon({ scopeEl: b, isExpand: x, isParent: y[f] }),
          (y[H] = x),
          y[s.id]);
      if ((v !== undefined && (c.status.expand[v] = x), null !== h)) {
                ...
                "function" === layui.type(C)
                  ...
                  : ((I = A.extend({}, m.where || o.where)),
                    ...
                    A.ajax({
                      ...
                      headers: _ || {},
                      success: function (e) {
                        (e = "function" == typeof k ? k.call(o, e) || e : e)[
                          w.statusName
                        ] != w.statusCode
                          ? ((y[V] = "error"),
                            (y[H] = !1),
            ...
            (y[X] = !0),
              v.length &&
                (!o.initSort ||
                  (o.url && !o.autoSort) ||
                  ((m = o.initSort).type
                    ? layui.sort(v, m.field, "desc" === m.type, !0)
                    : layui.sort(v, P.config.indexName, null, !0)),
                c.initData(y[s.children], y[z]),
        ...
        U(
          ...
          l &&
            "loading" !== y[V] &&
            ((C = u.callback.onExpand), "function" === layui.type(C)) &&
            C(r, y, x);
      }
      return h;
    },
    v =
            ...
            if (
              ...
              layui.each(e, function (e, t) {
                ...
                layui.each(["main", "fixed-l", "fixed-r"], function (e, t) {
                  l.find(".layui-table-" + t + " tbody").html(
      ...
      (a.prototype.updateNodeIcon = function (e) {
        ...
        a
          ...
          .css(
            "visibility",
            e || t.view.showFlexIconIfNotParent ? "visible" : "hidden"
          )
      ...
      (a.prototype.renderTreeTable = function (e, t, a) {
        var l = this,
          ...
          y =
            ((t = t || 0) ||
              ...
              layui.each(P.cache[i], function (e, t) {
                ...
                d
                  .find(
                    '.layui-table-main tbody tr[data-level="0"]:eq(' + e + ")"
                  )
                  .attr("lay-data-index", t),
                  d
                    .find(
                      '.layui-table-fixed-l tbody tr[data-level="0"]:eq(' +
                        e +
                        ")"
                    )
                    .attr("lay-data-index", t),
                  d
                    .find(
                      '.layui-table-fixed-r tbody tr[data-level="0"]:eq(' +
                        e +
                        ")"
                    )
                    .attr("lay-data-index", t);
          ...
          x = o.indent || 14;
        if (
          (layui.each(e.find('td[data-field="' + p + '"]'), function (e, t) {
            var a,
              n,
              i = (t = A(t)).closest("tr"),
            ...
            t.hasClass("layui-table-tree-item") ||
              ((n = i.attr("lay-data-index")) &&
                ...
                (n = t.html()),
                (t = i.find(
                  'td[data-field="' + p + '"]>div.layui-table-cell'
                )).addClass("layui-table-tree-item"),
                t
                  .html(
                    [
                      '<div class="layui-inline layui-table-tree-flexIcon" ',
                      'style="',
                      "margin-left: " + x * i.attr("data-level") + "px;",
    ...
    N =
      ((a.prototype.render = function (e) {
        var t = this;
        (t.tableIns = P["reloadData" === e ? "reloadData" : "reload"](
      ...
      function (e, a, n, i) {
        ...
        return (
          layui.each(e, function (e, t) {
            "function" === layui.type(a) ? a(t) : A.extend(t, a),
              l.push(A.extend({}, t)),
              i || (l = l.concat(N(t[n], a, n, i)));
          }),
          l
        );
      }),
    o =
      ...
      (B.updateStatus = function (e, t, a) {
        var e = j(e),
          n = e.getOptions();
        return (
          (a = a || (n.url ? P.cache[n.id] : n.data)), e.updateStatus(a, t)
        );
      }),
      (B.sort = function (e) {
        var t,
        ...
        d &&
          ...
          t.autoSort) &&
          ((n = t.initSort).type
            ? l(a, n.field, "desc" === n.type)
            : l(a, P.config.indexName, null),
          (P.cache[e] = a),
          d.initData(a),
          B.renderData(e));
      }),
    ...
    u =
      ((B.updateNode = function (e, a, t) {
        ...
        o &&
          ...
          layui.each(["main", "fixed-l", "fixed-r"], function (e, t) {
            n.find(
              ".layui-table-" + t + ' tbody tr[lay-data-index="' + a + '"]'
            ).replaceWith(
              A(r[["trs", "trs_fixed", "trs_fixed_r"][e]].join(""))
                .attr({ "data-index": i, "lay-data-index": a, "data-level": l })
                .data("index", i)
            );
          }),
      ...
      (B.removeNode = function (e, t, a) {
        var n,
          ...
          s = j(e);
        s &&
          ((i = (u = (n = s.getOptions()).tree).customName.isParent),
          (l = u.customName.children),
          (d = n.elem.next()),
          (r = []),
          (o = P.cache[e]),
          (t = s.getNodeDataByIndex(
            "string" === layui.type(t) ? t : t[z],
            !1,
            "delete"
          )),
          (c = s.getNodeDataByIndex(t[f])),
          s.updateCheckStatus(c),
          (u = s.treeToFlat([t], t[u.customName.pid], t[f])),
          layui.each(u, function (e, t) {
            t = t[z];
            r.push('tr[lay-data-index="' + t + '"]'),
              -1 !== t.indexOf("-") && delete o[t];
          }),
          d.find(r.join(",")).remove(),
          (t = s.initData()),
          (function () {
            for (var e in o)
              -1 !== e.indexOf("-") && e !== o[e][z] && delete o[e];
          })(),
          layui.each(s.treeToFlat(t), function (e, t) {
            t[b] &&
              t[b] !== t[z] &&
              d
                .find('tr[lay-data-index="' + t[b] + '"]')
                .attr({ "data-index": t[z], "lay-data-index": t[z] })
                .data("index", t[z]);
          }),
          layui.each(o, function (e, t) {
            d.find('tr[data-level="0"][lay-data-index="' + t[z] + '"]')
              .attr("data-index", e)
              .data("index", e);
          }),
          n.hasNumberCol && v(s),
          c &&
            ((u = d.find('tr[lay-data-index="' + c[z] + '"]')),
            a || (c[i] = !(!c[l] || !c[l].length)),
            s.updateNodeIcon({ scopeEl: u, isExpand: c[H], isParent: c[i] })),
          B.resize(e));
      }),
      (B.addNodes = function (e, t) {
        ...
        if (a) {
          var n = a.getOptions(),
            ...
            c = t.data,
            t = t.focus,
            u = (r = "number" === layui.type(r) ? r.toString() : r)
          ...
          if (u) {
              ...
              n.url ||
                (n.page
                  ? ((y = n.page),
                    n.data.splice.apply(
                      n.data,
                      [y.limit * (y.curr - 1), y.limit].concat(P.cache[e])
                    ))
                  : (n.data = P.cache[e])),
              a.initData(),
            ...
            -1 == r
              ? y.find('tr[data-level="0"][data-index="0"]')[0]
                ...
                : (y.find("tbody").prepend(h.trs),
                  n.find("tbody").prepend(h.trs_fixed),
                  f.find("tbody").prepend(h.trs_fixed_r))
              : -1 === o
          ...
          return (
            ...
            u &&
              ((o = l.find('tr[lay-data-index="' + u[z] + '"]')),
              a.updateNodeIcon({ scopeEl: o, isExpand: u[H], isParent: u[s] })),
            B.resize(e),
            t &&
              l
                .find(q)
      ...
      (B.checkStatus = function (e, n) {
        ...
        if (l)
          return (
            ...
            (a = !0),
            layui.each(
              "all" === l.data.cascade ? P.cache[e] : B.getData(e, !0),
              function (e, t) {
                if (!t[i]) return !(a = !1);
              }
            ),
      ...
      B.on("rowDouble", function (e) {
        ...
        a.hasClass(m) &&
          ...
          J({ trElem: e.tr.first() }, null, null, null, !0);
      }),
      ...
      (a.prototype.setRowCheckedClass = function (e, t) {
        ...
        e[t ? "addClass" : "removeClass"](l),
          e.each(function () {
            ...
            n.find('.layui-table-fixed-r tbody tr[data-index="' + e + '"]')[
          ...
          ("all" !== (d = a.data.cascade) && "parent" !== d) ||
            ...
            layui.each(d, function (e, t) {
              ...
              c.setRowCheckedClass(a.closest("tr"), n),
                a.prop({ checked: n, indeterminate: t[g] });
            })),
          (o = !(r = !0)),
          0 <
          (e = (e =
            "all" === a.data.cascade ? P.cache[n] : B.getData(n, !0)).filter(
            function (e) {
              return !e[u.disabledName];
            }
          )).length
            ? layui.each(e, function (e, t) {
                if (((t[l] || t[g]) && (o = !0), t[l] || (r = !1), o && !r))
                  return !0;
              })
            : (r = !1),
          (o = o && !r),
      ...
      (a.prototype.updateParentCheckStatus = function (a, n) {
        ...
        return (
          ...
          d.push(A.extend({}, a)),
          (d = a[f]
            ? d.concat(this.updateParentCheckStatus(P.cache[e][a[f]], n))
            : d)
        );
      }),
      function (e, t, a) {
        ...
        if (a) {
          ...
          i
            ? t && !o.prop("checked") && a()
            : ("boolean" === layui.type(t) && o.prop("checked") === t) || a();
        } else {
          var c,
          ...
          if (!i)
            return (
              ...
              d.prop({ checked: t, indeterminate: !1 }),
  ...
  B.on("checkbox", function (e) {
    var t = e.config,
      ...
      t = t.id;
    a.hasClass(m) &&
      ((a = j(t)), (t = e.checked), o(e), (e.isAll = u.call(a, e.tr, t)));
  }),
    (B.setRowChecked = function (a, e) {
      ...
      c &&
        ...
        (n = e.checked),
        (e = e.callbackFlag),
        (i = "string" === layui.type(i) ? i : i[z]),
        (r = c.getNodeDataByIndex(i))) &&
        ((l = function (e) {
          o.push(e),
            t.find('tr[lay-data-index="' + e + '"]').length ||
              ((e = c.getNodeDataByIndex(e)[f]) && l(e));
        }),
    ...
    (B.getNodesByFilter = function (e, t, a) {
      ...
      if (d)
        return (
          ...
          (i = d
            .treeToFlat(a ? a[i.tree.customName.children] || [] : P.cache[e])
            .filter(t)),
          (l = []),
          layui.each(i, function (e, t) {
...
layui.define("component", function (e) {
  ...
  var p = layui.$,
    C = layui.component({
      name: "tabs",
      config: { elem: ".layui-tabs", trigger: "click", headerMode: "auto" },
      CONST: {
        ELEM: "layui-tabs",
      ...
      render: function () {
        var a,
          ...
          t = n.config,
          e =
            ((n.headerElem = ["." + C.CONST.HEADER + ":eq(0)", ">li"]),
            (n.bodyElem = ["." + C.CONST.BODY + ":eq(0)", ">." + C.CONST.ITEM]),
            ...
            "array" === layui.type(t.header)
              ? "string" == typeof t.header[0]
                ? ((n.headerElem = t.header.concat()),
                  (n.documentElem = p(document)))
                : ((n.elemView = p('<div class="layui-tabs"></div>')),
                  t.className && n.elemView.addClass(t.className),
                  (a = p('<ul class="layui-tabs-header"></ul>')),
                  (i = p('<div class="layui-tabs-body"></div>')),
                  layui.each(t.header, function (e, t) {
                  ...
                  n.elemView.append(a).append(i),
                  t.elem.html(n.elemView))
              : n.renderClose(),
            "array" === layui.type(t.body) &&
              "string" == typeof t.body[0] &&
              ((n.documentElem = p(document)), (n.bodyElem = t.body.concat())),
            n.data());
        "index" in t && e.index != t.index
          ? n.change(n.findHeaderItem(t.index), !0)
          : -1 === e.index && n.change(n.findHeaderItem(0), !0),
          n.roll("auto"),
          t.elem.hasClass(C.CONST.CLASS_HIDEV) &&
            t.elem.removeClass(C.CONST.CLASS_HIDEV),
          "function" == typeof t.afterRender && t.afterRender(e),
          layui.event.call(
            t.elem[0],
            C.CONST.MOD_NAME,
            "afterRender(" + t.id + ")",
  ...
  (t.prototype.add = function (e) {
    var t,
      ...
      d = i.renderBodyItem(e),
      o = i.data();
    (e = p.extend({ active: !0 }, e)),
      /(before|after)/.test(e.mode)
        ? ((a = (t = e.hasOwnProperty("index"))
            ? i.findHeaderItem(e.index)
            : o.thisHeaderItem),
          (t = t ? i.findBodyItem(e.index) : o.thisHeaderItem),
          a[e.mode](r),
          t[e.mode](d))
        : ((a =
            { prepend: "prepend", append: "append" }[e.mode || "append"] ||
            "append"),
          n.header.elem[a](r),
          n.body.elem[a](d)),
      e.active ? i.change(r, !0) : i.roll("auto"),
      "function" == typeof e.done &&
        e.done(p.extend(o, { headerItem: r, bodyItem: d }));
  }),
          ...
          if (!t)
            if (
              ...
              layui.event.call(
                ...
                C.CONST.MOD_NAME,
                "beforeClose(" + i.id + ")",
                p.extend(r, { index: e.index() })
              )
            )
              return;
          e.hasClass(C.CONST.CLASS_THIS) &&
            (e.next()[0]
              ? a.change(e.next(), !0)
              : e.prev()[0] && a.change(e.prev(), !0)),
            e.remove(),
            a.findBodyItem(n).remove(),
            a.roll("auto", n);
          r = a.data();
          layui.event.call(
            r.thisHeaderItem[0],
    ...
    (t.prototype.closeMult = function (e, t) {
      var a,
        ...
        s = ":not(" + r + ")",
        d =
          ((t = t === undefined ? d.index : t),
          o.each(function (e) {
            var t = p(this).attr("lay-closable");
            t && l.eq(e).attr("lay-closable", t);
          }),
          "false" !== d.thisHeaderItem.attr("lay-closable") &&
            ("all" !== e && e
              ? t !== d.index && i.change(i.findHeaderItem(t), !0)
              : ((a = o.filter(":gt(" + d.index + ")" + r).eq(0)),
                (r = p(
                  o
                    .filter(":lt(" + d.index + ")" + r)
                    .get()
                ...
                a[0] ? i.change(a, !0) : r[0] && i.change(r, !0))),
          ("other" === e
            ? (o.eq(t).siblings(s).remove(), l.eq(t).siblings(s))
            : "right" === e
            ? (o.filter(":gt(" + t + ")" + s).remove(),
              l.filter(":gt(" + t + ")" + s))
            : (o.filter(s).remove(), l.filter(s))
          ).remove(),
          i.roll("auto"),
          i.data());
      layui.event.call(
    ...
    (t.prototype.change = function (e, t) {
      if (e && e[0]) {
        var a = this,
          i = a.config,
          n = e.attr("lay-id") || e.index(),
          r = e.find("a"),
          r =
            "string" == typeof r.attr("href") && "_blank" === r.attr("target"),
          d = "string" == typeof e.attr("lay-unselect");
        if (!r && !d) {
          r = a.data();
          if (!t)
            if (
              ...
              layui.event.call(
                ...
                "beforeChange(" + i.id + ")",
                p.extend(r, {
                  from: { index: r.index, headerItem: r.thisHeaderItem },
                  to: { index: e.index(), headerItem: e },
                })
              )
            )
              return;
          e
            .addClass(C.CONST.CLASS_THIS)
            .siblings()
            .removeClass(C.CONST.CLASS_THIS),
            a
              .findBodyItem(n)
              .addClass(C.CONST.CLASS_SHOW)
              .siblings()
              .removeClass(C.CONST.CLASS_SHOW),
            a.roll("auto", n);
          r = a.data();
          layui.event.call(
            r.thisHeaderItem[0],
    ...
    (t.prototype.renderHeaderItem = function (e) {
      var t = this.config,
        t = p(e.headerItem || t.headerItem || "<li></li>");
      return (
        t.html(e.title || "New Tab").attr("lay-id", e.id),
        this.appendClose(t, e),
        t
      );
    }),
    (t.prototype.renderBodyItem = function (e) {
      var t = this.config,
        t = p(
          e.bodyItem || t.bodyItem || '<div class="' + C.CONST.ITEM + '"></div>'
        );
      return t.html(e.content || "").attr("lay-id", e.id), t;
    }),
    (t.prototype.appendClose = function (e, t) {
      var a = this;
      a.config.closable &&
        0 != (t = t || {}).closable &&
        "false" !== e.attr("lay-closable") &&
        !e.find("." + C.CONST.CLOSE)[0] &&
        ((t = p(
          '<i class="layui-icon layui-icon-close layui-unselect ' +
            C.CONST.CLOSE +
            '"></i>'
    ...
    (t.prototype.renderClose = function () {
      var t = this,
        a = t.config;
      t.getContainer().header.items.each(function () {
        var e = p(this);
        a.closable ? t.appendClose(e) : e.find("." + C.CONST.CLOSE).remove();
      });
    }),
    (t.prototype.roll = function (e, i) {
      var n = this,
        ...
        m = {
          elem: p(
            '<div class="' + c + ' layui-border-box layui-unselect"></div>'
          ),
          bar: p(
            [
              '<div class="' + f + '">',
              '<i class="layui-icon ' + u[0] + '" lay-mode="prev"></i>',
              '<i class="layui-icon ' + u[1] + '" lay-mode="next"></i>',
              "</div>",
            ].join("")
          ),
        };
      if ("normal" !== t.headerMode) {
        ...
        if (s || (!s && o < a))
          y[0] ||
            (t.elem.hasClass(C.CONST.CARD) && m.elem.addClass(C.CONST.CARD),
            r.wrap(m.elem),
            r.after(m.bar),
            m.bar.children().on("click", function () {
          ...
          "prev" === e
            ? ((h = -l - o) < 0 && (h = 0),
              d.each(function (e, t) {
                ...
                if (h <= t) return r.css("left", -t).data("left", -t), !1;
              }))
            : "auto" === e
            ? (function () {
                ...
                if (e[0]) {
                  ...
                  if (
                    (0 < (a = t - (e.prev().outerWidth() || 0)) && (a -= 1),
                    l + a < 0)
                  )
                    return (
                      (l = 0 <= a ? a : 0), r.css("left", -l).data("left", -l)
                    );
                  var a = t + e.outerWidth() + (e.next().outerWidth() || 0) + 1;
                  0 < l + a - o &&
                    ((l = a - o), r.css("left", -l).data("left", -l));
                }
              })()
            : d.each(function (e, t) {
                var t = p(t),
                  a = Math.ceil(t.position().left);
                if (a + t.outerWidth() >= o - l)
                  return r.css("left", -a).data("left", -a), !1;
              }),
          (l = r.data("left") || 0),
          y
            .find("." + u[0])
            [l < 0 ? "removeClass" : "addClass"](C.CONST.CLASS_DISABLED),
          y
            .find("." + u[1])
            [0 < parseFloat(l + a) - o ? "removeClass" : "addClass"](
              C.CONST.CLASS_DISABLED
            ));
      }
    }),
    (t.prototype.findHeaderItem = function (e) {
      var t = this.getContainer().header.items,
        a = t.filter('[lay-id="' + e + '"]');
      return a[0] ? a : t.eq(e);
    }),
    (t.prototype.findBodyItem = function (e) {
      ...
      return i[0]
        ? i
        : ((i = t.header.items.filter('[lay-id="' + e + '"]'))[0] &&
            (e = i.index()),
          a.eq(e));
    }),
    ...
    p.extend(C, {
      ...
      close: function (e, t, a) {
        e = C.getInst(e);
        e &&
          (t === undefined && (t = e.data().index),
          e.close(e.findHeaderItem(t), a));
      },
  ...
  (l.prototype.config = {
    ...
    (l.prototype.spread = function (n, t) {
      ...
      d.on("click", function (e) {
        var i = n.children("." + N),
          a = (
            d.children(".layui-icon")[0] ? d : d.find(".layui-tree-icon")
          ).children(".layui-icon");
        i[0]
          ? n.hasClass(F)
            ? (n.removeClass(F),
    ...
    (l.prototype.setCheckbox = function (e, i, a) {
      var t,
        ...
        c = a.prop("checked");
      a.prop("disabled") ||
        (("object" != typeof i[l.children] && !e.find("." + N)[0]) ||
          e
            .find("." + N)
      ...
      i.setChecked(i.checkids),
        ...
        i.elem.find(".layui-tree-search").on("keydown", function () {
          p(this)
            ...
            p(".layui-tree-emptyText")[0] &&
              p(".layui-tree-emptyText").remove();
        });
    }),
  ...
  (v.prototype.config = {
    ...
    (v.prototype.render = function () {
      var e = this,
        t = e.config,
        a = (e.elem = d(
          n(p, { open: "{{", close: "}}", tagStyle: "legacy" }).render({
            data: t,
            index: e.index,
          })
        )),
...
layui.define(["jquery", "lay"], function (e) {
  ...
  (n.prototype.config = {
      ...
      if (1 < i.length)
        return (
          layui.each(i, function () {
            t.render(o.extend({}, n, { elem: this }));
          }),
          e
        );
      o.extend(n, l.options(i[0])),
        (n.elem = o(n.elem)),
        n.elem[0] &&
          ...
          e.elemItem.eq(n.index).addClass(s),
          e.indicator(),
          e.arrow(),
          e.autoplay(),
          1 < e.elemItem.length) &&
    ...
    (n.prototype.addIndex = function (e) {
      var n = this.config;
      (n.index = n.index + (e = e || 1)),
        n.index >= this.elemItem.length && (n.index = 0);
    }),
    (n.prototype.subIndex = function (e) {
      var n = this.config;
      (n.index = n.index - (e = e || 1)),
        n.index < 0 && (n.index = this.elemItem.length - 1);
    }),
    ...
    (n.prototype.arrow = function () {
        ...
        t = o(
          [
            '<button type="button" class="layui-icon ' +
              ("updown" === e.anim ? "layui-icon-up" : "layui-icon-left") +
              " " +
              a +
              '" lay-type="sub"></button>',
            '<button type="button" class="layui-icon ' +
              ("updown" === e.anim ? "layui-icon-down" : "layui-icon-right") +
              " " +
              a +
              '" lay-type="add"></button>',
          ].join("")
      ...
      e.elem.attr("lay-arrow", e.arrow),
        e.elem.find("." + a)[0] && e.elem.find("." + a).remove(),
        1 < i ? e.elem.append(t) : t.remove(),
        t.on("click", function () {
    ...
    (n.prototype["goto"] = function (e) {
      var n = this,
        i = n.config;
      e > i.index
        ? n.slide("add", e - i.index)
        : e < i.index && n.slide("sub", i.index - e);
    }),
    (n.prototype.indicator = function () {
        ...
        a = (e.elemInd = o(
          [
            ...
            layui.each(e.elemItem, function (e) {
              n.push(
                "<li" + (i.index === e ? ' class="layui-this"' : "") + "></li>"
              );
            }),
            n.join("")),
            "</ul></div>",
      ...
      i.elem.attr("lay-indicator", i.indicator),
        i.elem.find("." + d)[0] && i.elem.find("." + d).remove(),
        1 < t ? i.elem.append(a) : a.remove(),
        "updown" === i.anim && a.css("margin-top", -a.height() / 2),
        a
          .find("li")
    ...
    (n.prototype.slide = function (e, n) {
      ...
      i.haveSlide ||
        ...
        ("sub" === e
          ? (i.subIndex(n),
            t.eq(o.index).addClass(m),
            setTimeout(function () {
              t.eq(l).addClass(c), t.eq(o.index).addClass(c);
            }, 50))
          : (i.addIndex(n),
            t.eq(o.index).addClass(h),
            setTimeout(function () {
              t.eq(l).addClass(u), t.eq(o.index).addClass(u);
            }, 50)),
        setTimeout(function () {
          t.removeClass(s + " " + m + " " + h + " " + u + " " + c),
            t.eq(o.index).addClass(s),
            (i.haveSlide = !1);
        }, 350),
        i.elemInd.find("li").eq(o.index).addClass(s).siblings().removeClass(s),
        (i.haveSlide = !0),
        (a = { index: o.index, prevIndex: l, item: t.eq(o.index) }),
        "function" == typeof o.change && o.change(a),
        layui.event.call(this, r, "change(" + d + ")", a));
    }),
    (n.prototype.events = function () {
      var t,
        a,
...
layui.define("component", function (e) {
  ...
  var u = layui.$,
      ...
      render: function () {
        for (
          var e = this,
            ...
            t =
              (a.length < a.value && (a.value = a.length),
          ...
          var n =
            ...
            (i > Math.floor(a.value) ? c.ICON_RATE : c.ICON_RATE_SOLID) +
            '" ' +
            l +
            "></i></li>";
          a.half && parseInt(a.value) !== a.value && i == Math.ceil(a.value)
            ? (t =
                t +
        ...
        (t += "</ul>"),
          a.text && (t += '<span class="layui-inline">' + a.value + "</span>");
        var s = a.elem,
          o = s.next("." + c.ELEM);
        o[0] && o.remove(),
          (e.elemTemplate = u(t)),
          (a.span = e.elemTemplate.next("span")),
          a.setText && a.setText(a.value),
          s.html(e.elemTemplate),
          s.addClass("layui-inline"),
          a.readonly || e.action();
      },
    ...
    c = l.CONST;
  (l.Class.prototype.action = function () {
    var n = this.config,
      t = this.elemTemplate,
      i = t.find("i").width(),
      l = t.children("li");
    l.each(function (e) {
      ...
      l.on("click", function (e) {
        (n.value = a),
          n.half &&
            e.pageX - u(this).offset().left <= i / 2 &&
            (n.value = n.value - 0.5),
          n.text && t.next("span").text(n.value),
          n.choose && n.choose(n.value),
          n.setText && n.setText(n.value);
      }),
        l.on("mousemove", function (e) {
          t.find("i").each(function () {
            u(this).addClass(c.ICON_RATE).removeClass(c.ICON_SOLID_HALF);
          }),
            t.find("i:lt(" + a + ")").each(function () {
              u(this).addClass(c.ICON_RATE_SOLID).removeClass(c.ICON_HALF_RATE);
            }),
            n.half &&
              e.pageX - u(this).offset().left <= i / 2 &&
              l
                .children("i")
                .addClass(c.ICON_RATE_HALF)
                .removeClass(c.ICON_RATE_SOLID);
        }),
      ...
      a.touchSwipe(t, {
        onTouchMove: function (e, a) {
          ...
          Date.now() - a.timeStart <= 200 ||
            ...
            (i =
              (i =
                (e = a % 1) <= 0.5 && n.half ? 0.5 + (a - e) : Math.ceil(a)) >
              n.length
                ? n.length
                : i) < 0 && (i = 0),
            l.each(function (e) {
              var a = u(this).children("i"),
                ...
                e = i - e == 0.5;
              t
                ? (a.addClass(c.ICON_RATE_SOLID).removeClass(c.ICON_HALF_RATE),
                  n.half &&
                    e &&
                    a.addClass(c.ICON_RATE_HALF).removeClass(c.ICON_RATE_SOLID))
                : a.addClass(c.ICON_RATE).removeClass(c.ICON_SOLID_HALF),
        ...
        onTouchEnd: function (e, a) {
          Date.now() - a.timeStart <= 200 ||
            (t.find("i").removeClass("layui-rate-hover"),
            n.choose && n.choose(n.value),
            n.setText && n.setText(n.value));
        },
      });
...
layui.define("jquery", function (o) {
  ...
  (l.prototype.load = function (o) {
    ...
    if (v[0])
      return (
        ...
        (d = function (o, l) {
          ...
          (o = w(o)),
            p[f ? "after" : "before"](o),
            (l = 0 == l || null) ? p.html(a) : p.find("a").html(u),
            (n = l),
            (i = null),
            r && r(),
            f &&
              ((o = s
                ? c.prop("scrollHeight")
                : document.documentElement.scrollHeight),
              1 === h ? c.scrollTop(o) : 1 < h && c.scrollTop(t + (o - e)));
        }),
        (y = function () {
          (i = !0),
            p
            ...
            "function" == typeof o.done && o.done(++h, d);
        })(),
    ...
    (l.prototype._cleanup = function (o, l) {
      l.off("scroll.flow").off("scroll.lazyimg"),
        o.find(".layui-flow-more").find("a").off("click.flow");
    }),
    o("flow", new l());
});
        ...
        : (o = l.elem = x(l.elem))[0] &&
          ...
          "reloadCode" === e
            ...
            : ((d = layui.code.index = ++R),
              ...
              o.addClass(
                ((E = ["layui-code-view layui-border-box"]),
                l.wordWrap || E.push("layui-code-nowrap"),
                E.join(" "))
              ),
              (C = l.theme || l.skin) &&
                (o.removeClass("layui-code-theme-dark layui-code-theme-light"),
                o.addClass("layui-code-theme-" + C)),
              l.highlighter &&
                o.addClass(
                  [l.highlighter, "language-" + l.lang, "layui-code-hl"].join(
                    " "
                  )
                ),
              ...
              (v = [
                ...
                {
                  selector:
                    ">.layui-code-wrap>.layui-code-line>.layui-code-line-number{}",
                  setValue: function (e, t) {
                    e.style.width = t + "px";
                  },
                },
              ...
              (m = lay.style({
                ...
                text: x
                  .map(
                    ...
                    function (e, t) {
                      return [
                        '.layui-code-view[lay-code-index="' + d + '"]',
                        e,
                      ].join(" ");
                    }
                  )
              ...
              l.langMarker &&
                M.append(
                  '<span class="layui-code-lang-marker">' + l.lang + "</span>"
                ),
